Public Class UI_TerminDialog
 ...
 End Sub
    ...
    Overrides Sub SimpanData()
        ...
        instance.Tempo = txtTempo.EditValue
        instance.DiscDay = txtDisc.EditValue
        instance.DiscPersen = txtDiscP.EditValue
        instance.PenaltiesDay = txtDenda.EditValue
        instance.PenaltiesPersen = txtDendaP.EditValue
        instance.Save()
