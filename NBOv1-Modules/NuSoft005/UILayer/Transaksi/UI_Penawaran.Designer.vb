...
Partial Class UI_Penawaran
  ...
  Private Sub InitializeComponent()
    ...
    'barMan
    '
    Me.barMan.Items.AddRange(New DevExpress.XtraBars.BarItem() {Me.BarSubItem1, Me.btnUpdate, Me.btnPosting, Me.btnUnposting, Me.btnClosing, Me.btnSaveLayout, Me.btnHistory})
    Me.barMan.MaxItemId = 22
    '
    'xGridView
    '
    Me.xGridView.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colId, Me.colTahun, Me.colBulan, Me.colKode, Me.colTanggal, Me.colVendor, Me.colNoPermintaan, Me.colCatatan1, Me.colTotal, Me.colStatusTransaksi1, Me.colcreated_date1, Me.colcreated_user1, Me.collast_date1, Me.collast_modified1})
    ...
    Me.ifSource.ObjectType = GetType(NuSoft.NUI.Win.Forms.Modules.NuSoft005.Persistent.Penawaran)
    '
    'popMenu
    '
    Me.popMenu.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() {New DevExpress.XtraBars.LinkPersistInfo(DevExpress.XtraBars.BarLinkUserDefines.PaintStyle, Me.btnHistory, "", True, True, True, 0, Nothing, DevExpress.XtraBars.BarItemPaintStyle.CaptionGlyph)})
    '
    'barMenu
    '
    ...
    Me.Text = "Permintaan Penawaran [RQ]"
    Me.xpCol = Me.xpCol
  ...
  Friend WithEvents xbtnUnposting As DevExpress.XtraBars.BarButtonItem
  Friend WithEvents xbtnPosting As DevExpress.XtraBars.BarButtonItem
