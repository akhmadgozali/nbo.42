...
Friend Class UI_PenerimaanBarangDialogS
  ...
  Private Sub btnRefresh_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles btnRefresh.ItemClick
    BindingDataSource()
  End Sub
  Private Sub btnSerial_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles btnSerial.ItemClick
    Dim Id As Persistent.PenerimaanBarangDetail = CType(xGridView.GetRow(xGridView.FocusedRowHandle), Persistent.PenerimaanBarangDetail)
    Dim a As New UI_PenerimaanBarangDialogSerial(Id)
    a.session = session
    a.ShowDialog()
  End Sub
