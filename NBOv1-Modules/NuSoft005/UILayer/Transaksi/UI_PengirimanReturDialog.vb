...
Friend Class UI_PengirimanReturDialog
  Private instance As Persistent.PengirimanRetur
  Private isShown As Boolean
  Private xpSettingRegional As XPCollection(Of NuSoft001.Persistent.SettingRegional)
  Private editAssign As Boolean = False
  Private detailToDelete As New List(Of Persistent.PengirimanReturDetail)
  Private defaultRegional As NPO.Modules.ModSys.Regional
  Private setting As NuSoft001.Logic.FinaSetting
  Private sumber As Persistent.SumberDataCollection
  Private purchaseSetting As Logic.PurchaseSetting
  Sub New()
    InitializeComponent()
    NoDropIdentityMap = True
    Persistent.PengirimanRetur.AutoSaveOnEndEdit = False
    Persistent.PengirimanReturDetail.AutoSaveOnEndEdit = False
  ...
  Overrides Sub LoadBeforeInitialize()
    ...
    purchaseSetting = New Logic.purchaseSetting(session)
    BindingDataSource()
    sumber = New Persistent.SumberDataCollection(session)
    LoadLayout()
    If My.Computer.FileSystem.FileExists(Logic.Umum.xLokasiLayout("DNTransaksi.xml")) = True Then
      lytTransaksi.RestoreLayoutFromXml(Logic.Umum.xLokasiLayout("DNTransaksi.xml"))
    End If
    If My.Computer.FileSystem.FileExists(Logic.Umum.xLokasiLayout("DNTransaksiGrid.xml")) = True Then
      xGridView.RestoreLayoutFromXml(Logic.Umum.xLokasiLayout("DNTransaksiGrid.xml"))
    End If
  End Sub
  Overrides Sub InitializeData()
    ...
    If Tipe = InputType.Tambah Then
      instance = New Persistent.PengirimanRetur(session)
    ...
    Else
      editAssign = True
      xGrid.DataSource = Nothing
      instance = session.GetObjectByKey(Of Persistent.PengirimanRetur)(Convert.ToInt64(IdToEdit))
  ...
  Overrides Sub LoadAfterInitialize()
    SetFormat()
    If Tipe = InputType.Tambah Then
      Me.Text = "Pengiriman Retur [DN]: Tambah Data"
    Else
      Me.Text = "Pengiriman Retur [DN]: Edit Data " & instance.Kode
  ...
  Overrides Sub SimpanData()
    If (Not CType(txtStatus.EditValue, NuSoft001.Persistent.StatusTransaksiEnum) = NuSoft001.Persistent.StatusTransaksiEnum.Pending) And (Not CType(txtStatus.EditValue, NuSoft001.Persistent.StatusTransaksiEnum)) Then
  ...
  Private Sub BindingDataSource()
    If purchaseSetting.FilterKontak = True Then
      txtKontak.Properties.DataSource = New XPCollection(Of NuSoft001.Persistent.Kontak)(session, New BinaryOperator("TipeKontak.Id", purchaseSetting.TipeKontak, BinaryOperatorType.Equal))
    Else
  ...
  Private Sub LoadDefault()
    ...
    'txtUraian.EditValue = purchaseSetting.UraianDO
  ...
  Private Sub txtKontak_EditValueChanging(sender As Object, e As DevExpress.XtraEditors.Controls.ChangingEventArgs) Handles txtKontak.EditValueChanging
    If Not e.NewValue Is Nothing Then
      ...
      Dim xpTransaksi As New XPCollection(Of Persistent.PengirimanRetur)(session, New BinaryOperator("Vendor", CType(e.NewValue, NuSoft001.Persistent.Kontak), BinaryOperatorType.Equal))
  ...
  Private Sub xGridView_CellValueChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles xGridView.CellValueChanged
    If Not e.Value Is Nothing Then
      Dim row As Persistent.PengirimanReturDetail = CType(xGridView.GetRow(e.RowHandle), Persistent.PengirimanReturDetail)
  ...
  Private Sub xGridView_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles xGridView.KeyDown
    If e.KeyCode = Windows.Forms.Keys.Delete Then
      Dim Id As Persistent.PengirimanReturDetail = CType(xGridView.GetRow(xGridView.FocusedRowHandle), Persistent.PengirimanReturDetail)
