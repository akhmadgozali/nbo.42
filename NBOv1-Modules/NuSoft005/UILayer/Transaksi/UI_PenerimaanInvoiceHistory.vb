...
Public Class UI_PenerimaanInvoiceHistory
  ...
  Overrides Sub FirstLoad()
    ...
    xGrid.DataSource = New XPCollection(Of Persistent.PembayaranHutangDetail)(session, New BinaryOperator("NoInvoice.Id", _idinvoice, BinaryOperatorType.Equal))
