...
Partial Class UI_PembelianCash
  ...
  Private Sub InitializeComponent()
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(UI_PembelianCash))
    ...
    Me.colTotalTransaksi = New DevExpress.XtraGrid.Columns.GridColumn()
    ...
    'barMan
    '
    Me.barMan.Items.AddRange(New DevExpress.XtraBars.BarItem() {Me.BarButtonItem1, Me.BarButtonItem2, Me.btnUpdate, Me.btnPosting, Me.btnUnPosting, Me.btnClosing, Me.btnSaveLayout})
    Me.barMan.MaxItemId = 20
    '
    'xGridView
    '
    Me.xGridView.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colId, Me.colTahun, Me.colBulan, Me.colKode, Me.colTanggal, Me.colVendor, Me.colGudang, Me.colTotalTransaksi, Me.colStatusTransaksi1, Me.colGL})
    ...
    Me.ifSource.ObjectType = GetType(NuSoft.NUI.Win.Forms.Modules.NuSoft005.Persistent.PembelianCash)
    '
    'barMenu
    '
    ...
    'colTotalTransaksi
    '
    Me.colTotalTransaksi.Caption = "Total Transaksi"
    Me.colTotalTransaksi.FieldName = "TotalTransaksi"
    Me.colTotalTransaksi.Name = "colTotalTransaksi"
    Me.colTotalTransaksi.Visible = True
    Me.colTotalTransaksi.VisibleIndex = 4
    '
    'UI_PembelianCash
    '
    ...
    Me.Name = "UI_PembelianCash"
    Me.Text = "Pembelian Tunai [PC]"
    Me.xpCol = Me.xpCol
  ...
  Friend WithEvents colTotalTransaksi As DevExpress.XtraGrid.Columns.GridColumn
End Class
