...
Public Class UI_SanYuPenerimaanBarang
  ...
  Overrides Sub FirstLoad()
    ...
    'If NuSoft.Core.SSystem.User.GetPrivilegesMenu(12, "aa").Edit = True Then
    '  a
    'End If
  ...
  Overrides Function GetDialogForm() As Core.Win.Forms.InputBase
    Return New UI_SanYuPenerimaanBarangDialog
  End Function
  ...
  Overrides Function HapusData(selectedData As System.Collections.Generic.List(Of Core.Win.Forms.GridDeletedData)) As Boolean
    Dim item As Persistent.SanYu_PenerimaanBarang, pPending As Integer
    ...
    For i = 0 To selectedData.Count - 1
      If Not xGridView.IsGroupRow(selectedData(i).Row) Then
        ...
        item = CType(proxy.OriginalRow, Persistent.SanYu_PenerimaanBarang)
        If item.StatusTransaksi = NuSoft001.Persistent.StatusTransaksiEnum.Pending Then
          ...
          '  zdtGL.Delete()
          'End If
          Logic.Umum.SaveLog(session, Persistent.TipeLOG.Delete, "Admin", "Penerimaan Barang: Hapus " & item.Kode)
          item.Delete()
        Else
          pPending += 1
        End If
  ...
  Overrides Function GetToolTipContent(view As DevExpress.XtraGrid.Views.Grid.GridView, info As DevExpress.XtraGrid.Views.Grid.ViewInfo.GridHitInfo) As String
    Dim item As Persistent.SanYu_PenerimaanBarang
    Dim proxy As ReadonlyThreadSafeProxyForObjectFromAnotherThread
    ...
    Try
      ...
      For i = 0 To a.Count - 1
        ...
        Qty = a(i).Qty.ToString(toStringFormat) & " (" & a(i).Satuan.Kode & ") - " & a(i).Tonase & " Ton"
  ...
  Private Sub btnPosting_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles btnPosting.ItemClick, btnPending.ItemClick
  ...
  Sub setstatus(selectedData As System.Collections.Generic.List(Of Core.Win.Forms.GridDeletedData), xTipe As String)
    Dim item As Persistent.SanYu_PenerimaanBarang, xGagal As Integer, xMessage As String
    Dim proxy As ReadonlyThreadSafeProxyForObjectFromAnotherThread
  ...
  Private Sub btnCetakVoucher_ItemClick(sender As Object, e As ItemClickEventArgs) Handles btnCetakVoucher.ItemClick
    ...
    If note.Count > 0 Then
      ...
      message = String.Format(message, "Penerimaan Barang Pembelian")
