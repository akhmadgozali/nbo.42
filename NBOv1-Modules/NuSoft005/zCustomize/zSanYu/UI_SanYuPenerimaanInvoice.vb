...
Public Class UI_SanYuPenerimaanInvoice
  ...
  Overrides Sub FirstLoad()
    ...
    CreateCriteria = GroupOperator.And(New BinaryOperator("Sumber", Persistent.SumberDataJenis.RI, BinaryOperatorType.Equal), New InOperator("Regional", UserInfo.GetUserRegional(session, NamaDatabase)))
  ...
  Overrides Function GetDialogForm() As Core.Win.Forms.InputBase
    Return New UI_SanYuPenerimaanInvoiceDialog
  End Function
  ...
  Overrides Function HapusData(selectedData As System.Collections.Generic.List(Of Core.Win.Forms.GridDeletedData)) As Boolean
    Dim item As Persistent.SanYu_PenerimaanInvoice, pPending As Integer
    ...
    For i = 0 To selectedData.Count - 1
      If Not xGridView.IsGroupRow(selectedData(i).Row) Then
        ...
        If item.StatusTransaksi = NuSoft001.Persistent.StatusTransaksiEnum.Pending Then
          ...
          '  zdtGL.Delete()
          'End If
          Logic.Umum.SaveLog(session, Persistent.TipeLOG.Delete, "Admin", "Invoice Pembelian: Hapus " & item.Kode)
          item.Delete()
        Else
          pPending += 1
        End If
  ...
  Overrides Function GetToolTipContent(view As DevExpress.XtraGrid.Views.Grid.GridView, info As DevExpress.XtraGrid.Views.Grid.ViewInfo.GridHitInfo) As String
    Dim item As Persistent.SanYu_PenerimaanInvoice
    Dim proxy As ReadonlyThreadSafeProxyForObjectFromAnotherThread
    ...
    Try
      ...
      For i = 0 To a.Count - 1
        ...
        Qty = a(i).Qty.ToString(toStringFormat) & " (" & a(i).Satuan.Kode & ") - " & a(i).OrderPembelian.Tonase & " Ton"
  ...
  Private Sub btnCetakVoucher_ItemClick(sender As Object, e As ItemClickEventArgs) Handles btnCetakVoucher.ItemClick
    ...
    If note.Count > 0 Then
      ...
      Dim frm As New RF_SanYuVoucher(Persistent.SumberDataJenis.RI)
