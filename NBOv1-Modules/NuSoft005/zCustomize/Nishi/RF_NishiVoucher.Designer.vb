...
Partial Class RF_NishiVoucher
  ...
  Private Sub InitializeComponent()
    ...
    Me.txtNoBukti1.Properties.Columns.AddRange(New DevExpress.XtraEditors.Controls.LookUpColumnInfo() {New DevExpress.XtraEditors.Controls.LookUpColumnInfo("Kode", "No Transaksi"), New DevExpress.XtraEditors.Controls.LookUpColumnInfo("Tanggal", "Tanggal", 20, DevExpress.Utils.FormatType.None, "dd/MM/yyyy", True, DevExpress.Utils.HorzAlignment.[Default]), New DevExpress.XtraEditors.Controls.LookUpColumnInfo("NamaVendor", "Vendor")})
    ...
    Me.txtNoBukti2.Properties.Columns.AddRange(New DevExpress.XtraEditors.Controls.LookUpColumnInfo() {New DevExpress.XtraEditors.Controls.LookUpColumnInfo("Kode", "No Transaksi"), New DevExpress.XtraEditors.Controls.LookUpColumnInfo("Tanggal", "Tanggal"), New DevExpress.XtraEditors.Controls.LookUpColumnInfo("NamaVendor", "Vendor")})
