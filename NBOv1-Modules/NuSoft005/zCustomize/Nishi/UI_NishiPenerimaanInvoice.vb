...
Public Class UI_NishiPenerimaanInvoice
  ...
  Overrides Function GetDialogForm() As Core.Win.Forms.InputBase
    Return New UI_NishiPenerimaanInvoiceDialog
  End Function
  ...
  Overrides Function GetToolTipContent(view As DevExpress.XtraGrid.Views.Grid.GridView, info As DevExpress.XtraGrid.Views.Grid.ViewInfo.GridHitInfo) As String
    Dim item As Persistent.NishiPenerimaanInvoice
    Dim proxy As ReadonlyThreadSafeProxyForObjectFromAnotherThread
  ...
  Private Sub btnCetakVoucher_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles btnCetakVoucher.ItemClick
    ...
    If note.Count > 0 Then
      ...
      If item.CoaHutang.Tipe.Level2 = NuSoft001.Persistent.CoaEnum.eLevel2.Aktiva Then
        xReportName = MainClass.reportName.zNishiVoucherRIBiaya
      Else
        xReportName = MainClass.reportName.zNishiVoucherRITR
      End If

      Dim frm As RF_NishiVoucher
      ...
      frm = New RF_NishiVoucher(Persistent.SumberDataJenis.RI, xReportName)
      reportCode = MainClass.GetReport(xReportName)

      frm.txtNoBukti1.EditValue = item.Kode

      message = String.Format(message, "Biaya JO")
