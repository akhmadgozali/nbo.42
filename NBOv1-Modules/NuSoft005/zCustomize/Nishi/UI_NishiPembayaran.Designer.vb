...
Partial Class UI_NishiPembayaran
  ...
  Private Sub InitializeComponent()
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(UI_NishiPembayaran))
    ...
    Me.colGLSaldo = New DevExpress.XtraGrid.Columns.GridColumn()
    ...
    Me.ifSource.ObjectType = GetType(NuSoft.NUI.Win.Forms.Modules.NuSoft005.Persistent.NishiPembayaranHutang)
    '
    'popMenu
    '
    Me.popMenu.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() {New DevExpress.XtraBars.LinkPersistInfo(Me.btnCetakVoucher, True)})
    '
    'barMenu
    '
    ...
    Me.colStatusTransaksi1.VisibleIndex = 4
    '
    'btnUpdate
    '
    ...
    Me.colGL.Name = "colGL"
    Me.colGL.Visible = True
    Me.colGL.VisibleIndex = 5
    '
    'colKurs
    '
    ...
    'colGLSaldo
    '
    Me.colGLSaldo.FieldName = "Gl.Saldo"
    Me.colGLSaldo.Name = "colGLSaldo"
    Me.colGLSaldo.Visible = True
    Me.colGLSaldo.VisibleIndex = 6
    '
    'btnCetakVoucher
    '
  ...
  Friend WithEvents colGLSaldo As DevExpress.XtraGrid.Columns.GridColumn
