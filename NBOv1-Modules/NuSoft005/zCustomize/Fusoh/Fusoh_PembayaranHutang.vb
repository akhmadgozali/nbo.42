...
Namespace Persistent
  <Persistent("m05cmainpayment")> Friend Class Fusoh_PembayaranHutang
    ...
    <NonPersistent()> ReadOnly Property TotalGL As Double
      ...
      End Get
    End Property
    <Association("fk_fusoh_pembayaran_detail"), Aggregated> ReadOnly Property Detail As XPCollection(Of Fusoh_PembayaranHutangDetail)
      Get
        Return GetCollection(Of Fusoh_PembayaranHutangDetail)("Detail")
      End Get
    End Property
  ...
  Friend Class Fusoh_PembayaranHutangDetail
    Inherits NPOBase
    ...
    Private _main As Fusoh_PembayaranHutang
    Private _idinvoice As Fusoh_PenerimaanInvoice
    ...
    Property Id As Int64
      ...
      End Set
    End Property
    <Persistent("p_id"), Association("fk_fusoh_pembayaran_detail")>
    Property Main As Fusoh_PembayaranHutang
      Get
        Return _main
      End Get
      Set(value As Fusoh_PembayaranHutang)
        SetPropertyValue(Of Fusoh_PembayaranHutang)("Main", _main, value)
      End Set
    End Property
    <Persistent("p_idinvoice")>
    Property NoInvoice As Fusoh_PenerimaanInvoice
      Get
        Return _idinvoice
      End Get
      Set(value As Fusoh_PenerimaanInvoice)
        SetPropertyValue(Of Fusoh_PenerimaanInvoice)("NoInvoice", _idinvoice, value)
      End Set
    End Property
  ...
  Friend Class Fusoh_BayarHutangTemp
    Property NoInvoice As Fusoh_PenerimaanInvoice
