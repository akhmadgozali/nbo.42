...
Partial Class UI_FusohPembayaran
	...
	Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(UI_FusohPembayaran))
        ...
        'barMan
        '
        Me.barMan.Items.AddRange(New DevExpress.XtraBars.BarItem() {Me.btnUpdate, Me.btnPosting, Me.btnUnposting, Me.btnClosing, Me.btnSaveLayout, Me.btnShowLog})
        ...
        'ifSource
        '
        Me.ifSource.DisplayableProperties = "Id;Tahun;Bulan;Kode;Tanggal;Vendor.Nama;Uraian;Kurs;Total;StatusTransaksi;Gl.Kode" &
    ";Gl.Saldo"
        Me.ifSource.ObjectType = GetType(NuSoft.NUI.Win.Forms.Modules.NuSoft005.Persistent.Fusoh_PembayaranHutang)
        '
        'popMenu
        '
        Me.popMenu.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() {New DevExpress.XtraBars.LinkPersistInfo(Me.btnShowLog, True)})
        '
        'barMenu
        '
