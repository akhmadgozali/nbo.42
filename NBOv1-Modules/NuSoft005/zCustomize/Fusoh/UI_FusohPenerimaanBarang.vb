...
Public Class UI_FusohPenerimaanBarang
	...
	Overrides Function GetDialogForm() As Core.Win.Forms.InputBase
		Return New UI_FusohPenerimaanBarangDialog
	End Function
				...
				For i = 0 To selectedData.Count - 1
					If Not xGridView.IsGroupRow(selectedData(i).Row) Then
						...
						If data.StatusTransaksi = NuSoft001.Persistent.StatusTransaksiEnum.Pending Then
							...
							If item.Exim.PO.DariDomestik Then
								item.Exim.StatusTransaksi = status
							Else
								'update status invoice jika intl
								Dim findAll = New XPQuery(Of Persistent.Fusoh_PenerimaanInvoice)(session).Where(Function(w) w.NoExim Is item.Exim)
