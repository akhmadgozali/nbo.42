...
Partial Class UI_FusohCostSheet
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(UI_FusohCostSheet))
    ...
    Me.colTotalRp = New DevExpress.XtraGrid.Columns.GridColumn()
    ...
    Me.colIndukInvoice = New DevExpress.XtraGrid.Columns.GridColumn()
    Me.barCetakCostSheet = New DevExpress.XtraBars.BarButtonItem()
    Me.btnHPPMenu = New DevExpress.XtraBars.BarSubItem()
    ...
    Me.collast_modified1 = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.xGrid.Size = New System.Drawing.Size(780, 368)
        '
        'barMan
        '
        Me.barMan.Items.AddRange(New DevExpress.XtraBars.BarItem() {Me.btnUpdate, Me.btnPosting, Me.btnUnposting, Me.btnClosing, Me.btnSaveLayout, Me.barCetakCostSheet, Me.btnHPPMenu, Me.btnShowHPP, Me.btnResetHPP, Me.btnResetAll, Me.btnShowLog})
        Me.barMan.MaxItemId = 24
        '
        'xGridView
        '
        Me.xGridView.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colId, Me.colTahun, Me.colBulan, Me.colKode, Me.colNoInvoice, Me.colTanggal, Me.colVendor, Me.colUang, Me.colTotalRp, Me.colStatus, Me.colIndukInvoice, Me.GridColumn46, Me.colcreated_date1, Me.colcreated_user1, Me.collast_date1, Me.collast_modified1})
        ...
        Me.ifSource.ObjectType = GetType(NuSoft.NUI.Win.Forms.Modules.NuSoft005.Persistent.Fusoh_PenerimaanInvoice)
        '
        'popMenu
        '
        Me.popMenu.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() {New DevExpress.XtraBars.LinkPersistInfo(DevExpress.XtraBars.BarLinkUserDefines.PaintStyle, Me.barCetakCostSheet, "", True, True, True, 0, Nothing, DevExpress.XtraBars.BarItemPaintStyle.CaptionGlyph), New DevExpress.XtraBars.LinkPersistInfo(Me.btnShowLog, True)})
        '
        'barMenu
        '
        Me.barMenu.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() {New DevExpress.XtraBars.LinkPersistInfo(DevExpress.XtraBars.BarLinkUserDefines.PaintStyle, Me.btnUpdate, "", True, True, True, 0, Nothing, DevExpress.XtraBars.BarItemPaintStyle.CaptionGlyph), New DevExpress.XtraBars.LinkPersistInfo(DevExpress.XtraBars.BarLinkUserDefines.PaintStyle, Me.btnHPPMenu, "", True, True, True, 0, Nothing, DevExpress.XtraBars.BarItemPaintStyle.CaptionGlyph)})
        ...
        Me.colVendor.FieldName = "Vendor.Nama"
        Me.colVendor.Name = "colVendor"
        Me.colVendor.OptionsColumn.ReadOnly = True
        ...
        'colNoInvoice
        '
        Me.colNoInvoice.Caption = "Reff Cost."
        Me.colNoInvoice.FieldName = "NoReffVendor"
        ...
        'colTotalRp
        '
        Me.colTotalRp.Caption = "Total"
        Me.colTotalRp.FieldName = "Total"
        Me.colTotalRp.Name = "colTotalRp"
        Me.colTotalRp.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum)})
        Me.colTotalRp.Visible = True
        Me.colTotalRp.VisibleIndex = 5
        '
        'btnUpdate
        '
        ...
        'colIndukInvoice
        '
        Me.colIndukInvoice.Caption = "Invoice Pembelian"
        Me.colIndukInvoice.FieldName = "IndukInvoice.Kode"
        Me.colIndukInvoice.Name = "colIndukInvoice"
        Me.colIndukInvoice.Visible = True
        Me.colIndukInvoice.VisibleIndex = 7
        '
        'barCetakCostSheet
        '
        Me.barCetakCostSheet.Caption = "Cetak Cost Sheet"
        Me.barCetakCostSheet.Glyph = CType(resources.GetObject("barCetakCostSheet.Glyph"), System.Drawing.Image)
        Me.barCetakCostSheet.Id = 18
        Me.barCetakCostSheet.LargeGlyph = CType(resources.GetObject("barCetakCostSheet.LargeGlyph"), System.Drawing.Image)
        Me.barCetakCostSheet.Name = "barCetakCostSheet"
        '
        'btnHPPMenu
        '
        Me.btnHPPMenu.Caption = "HPP"
        Me.btnHPPMenu.Glyph = CType(resources.GetObject("btnHPPMenu.Glyph"), System.Drawing.Image)
        Me.btnHPPMenu.Id = 19
        Me.btnHPPMenu.LargeGlyph = CType(resources.GetObject("btnHPPMenu.LargeGlyph"), System.Drawing.Image)
        Me.btnHPPMenu.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() {New DevExpress.XtraBars.LinkPersistInfo(DevExpress.XtraBars.BarLinkUserDefines.PaintStyle, Me.btnShowHPP, DevExpress.XtraBars.BarItemPaintStyle.CaptionGlyph), New DevExpress.XtraBars.LinkPersistInfo(DevExpress.XtraBars.BarLinkUserDefines.PaintStyle, Me.btnResetHPP, DevExpress.XtraBars.BarItemPaintStyle.CaptionGlyph), New DevExpress.XtraBars.LinkPersistInfo(DevExpress.XtraBars.BarLinkUserDefines.PaintStyle, Me.btnResetAll, "", True, True, True, 0, Nothing, DevExpress.XtraBars.BarItemPaintStyle.CaptionGlyph)})
        Me.btnHPPMenu.Name = "btnHPPMenu"
        '
        'btnShowHPP
        '
        ...
        Me.Name = "UI_FusohCostSheet"
        Me.Text = "Cost Sheet [CS]"
        Me.xpCol = Me.xpCol
	...
	Friend WithEvents colTotalRp As DevExpress.XtraGrid.Columns.GridColumn
  ...
  Friend WithEvents colIndukInvoice As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents barCetakCostSheet As DevExpress.XtraBars.BarButtonItem
	Friend WithEvents btnHPPMenu As DevExpress.XtraBars.BarSubItem
