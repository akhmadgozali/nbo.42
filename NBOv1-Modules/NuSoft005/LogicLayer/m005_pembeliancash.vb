...
Namespace Persistent
  ...
  Friend Class PembelianCash
    ...
    End Property
    <Persistent("d_disc")>
    Property Disc As Double
      Get
        Return _disc
      End Get
      Set(value As Double)
        SetPropertyValue(Of Double)("Disc", _disc, value)
      End Set
    End Property
    <Persistent("d_status")>
    ...
    <Persistent("f_gl")> Property Gl As GlMain
      ...
      End Set
    End Property
    <Association("fk_pembelian_detail"), Aggregated> ReadOnly Property Detail As XPCollection(Of PembelianCashDetail)
      Get
        Return GetCollection(Of PembelianCashDetail)("Detail")
      End Get
    End Property
    ...
    <PersistentAlias("Detail.Sum(SubTotal)")> ReadOnly Property SubTotal As Double
      ...
      End Get
    End Property
    <PersistentAlias("Detail.Sum(SubTotal) - Disc")> ReadOnly Property TotalTransaksi As Double
      Get
        Return Convert.ToDouble(EvaluateAlias("TotalTransaksi"))
      End Get
    End Property
    Private Function CheckData() As Boolean
      Dim source As String = "Pembelian Tunai [PC]"
  ...
  Friend Class PembelianCashDetail
    Inherits NPOBase
    Public Sub New(ByVal session As UnitOfWork)
      MyBase.New(session)
    End Sub
    ...
    Private _main As Persistent.PembelianCash
    Private _gudang As NuSoft004.Persistent.Gudang
    ...
    Property Id As Int64
      ...
      End Set
    End Property
    <Persistent("p_id"), Association("fk_pembelian_detail")>
    Property Main As PembelianCash
      Get
        Return _main
      End Get
      Set(value As PembelianCash)
        SetPropertyValue(Of PembelianCash)("Main", _main, value)
      End Set
    End Property
    <Persistent("f_warehouse")>
    Property Gudang As NuSoft004.Persistent.Gudang
    ...
    Private Function CheckData() As Boolean
      ...
      If _main Is Nothing AndAlso Not IsDeleted Then
        Throw New Utils.Exception("Masukkan data utama pembelian tunai", -99, "", source)
        Return False
      End If
