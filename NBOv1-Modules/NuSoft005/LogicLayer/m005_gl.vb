  ...
  Friend Class GlMain
    ...
    Private Function CheckData() As Boolean
      ...
      If sumDebit.ToString("n4") <> sumKredit.ToString("n4") Then
        ...
        Next
        Throw New Utils.Exception("No :" & Kode & vbCrLf & "Debit=" & sumDebit & vbCrLf & "Kredit=" & sumKredit & vbCrLf & "Jurnal tidak seimbang" & vbCrLf & vbCrLf & "Jurnal sistem : " & vbCrLf & xMessageJurnal, -7, "Periksa lagi transaksi anda", source)
        Return False
      End If
      Return True
    End Function
