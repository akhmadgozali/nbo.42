...
Namespace Persistent
  ...
  Friend Class PengirimanRetur
    ...
    <Association("fk_retur_detail"), Aggregated> ReadOnly Property Detail As XPCollection(Of PengirimanReturDetail)
      Get
        Return GetCollection(Of PengirimanReturDetail)("Detail")
      End Get
    End Property
    Private Function CheckData() As Boolean
      Dim source As String = "Pengiriman Retur Barang [DN]"
  ...
  Friend Class PengirimanReturDetail
    Inherits NPOBase
    Public Sub New(ByVal session As UnitOfWork)
      MyBase.New(session)
    End Sub
    ...
    Private _main As Persistent.PengirimanRetur
    Private _gudang As NuSoft004.Persistent.Gudang
    ...
    Property Main As PengirimanRetur
      Get
        Return _main
      End Get
      Set(value As PengirimanRetur)
        SetPropertyValue(Of PengirimanRetur)("Main", _main, value)
      End Set
    End Property
    <Persistent("f_warehouse")>
    Property Gudang As NuSoft004.Persistent.Gudang
    ...
    End Property
    Private Function CheckData() As Boolean
      Dim source As String = "Pengiriman Barang Retur [DN]"
