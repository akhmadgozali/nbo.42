...
Namespace Persistent
  ...
  Friend Class Penawaran
    ...
    Property NoPermintaan As Persistent.PermintaanStock
      Get
        Return _nopermintaan
      End Get
      Set(value As Persistent.PermintaanStock)
        SetPropertyValue(Of Persistent.PermintaanStock)("NoPermintaan", _nopermintaan, value)
      End Set
    End Property
    ...
    Private Function CheckData() As Boolean
      Dim source As String = "Permintaan Penawaran [RQ]"
    ...
    End Sub
  End Class
  <Persistent("m05ddetailquotation")>
  Friend Class PenawaranDetail
    ...
    End Property
    <Persistent("f_idrequest")>
    Property PermintaaanDetail As Persistent.PermintaanStockDetail
      Get
        Return _idpermintaan
      End Get
      Set(value As Persistent.PermintaanStockDetail)
        SetPropertyValue(Of Persistent.PermintaanStockDetail)("PermintaaanDetail", _idpermintaan, value)
      End Set
    End Property
    Private Function CheckData() As Boolean
      Dim source As String = "Permintaan Penawaran [RQ]"
