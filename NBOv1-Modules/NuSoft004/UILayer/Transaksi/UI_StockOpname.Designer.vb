...
Partial Class UI_StockOpname
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(UI_StockOpname))
    ...
    Me.colStatusTrans = New DevExpress.XtraGrid.Columns.GridColumn()
    ...
    'xGridView
    '
    Me.xGridView.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colId, Me.colTahun, Me.colBulan, Me.colSumber, Me.colKode, Me.colTanggal, Me.colKaryawan, Me.colGudang, Me.colCatatan1, Me.colStatusTrans})
    ...
    'ifSource
    '
    Me.ifSource.ObjectType = GetType(NuSoft.NUI.Win.Forms.Modules.NuSoft004.Persistent.StockOpname)
    '
    'popMenu
    '
    ...
    Me.colKaryawan.FieldName = "Karyawan.Kode"
    ...
    'colStatusTrans
    '
    Me.colStatusTrans.FieldName = "StatusTransaksi"
    Me.colStatusTrans.Name = "colStatusTrans"
    Me.colStatusTrans.Visible = True
    Me.colStatusTrans.VisibleIndex = 5
    '
    'btnSaveLayout
    '
  ...
  Friend WithEvents colStatusTrans As DevExpress.XtraGrid.Columns.GridColumn
