...
Friend Class UI_StockOpnameDialog
  Private instance As Persistent.StockOpname
  Private isShown As Boolean
  Private xpSettingRegional As XPCollection(Of NuSoft001.Persistent.SettingRegional)
  Private editAssign As Boolean = False
  Private detailToDelete As New List(Of Persistent.StockOpnameDetail)
  ...
  Sub New()
    ...
    Persistent.StockOpname.AutoSaveOnEndEdit = False
    Persistent.StockOpnameDetail.AutoSaveOnEndEdit = False
  ...
  Overrides Sub LoadBeforeInitialize()
    ...
    If My.Computer.FileSystem.FileExists(Logic.Umum.xLokasiLayout("OSTransaksi.xml")) = True Then
      lytTransaksi.RestoreLayoutFromXml(Logic.Umum.xLokasiLayout("OSTransaksi.xml"))
    End If
  End Sub
  Overrides Sub InitializeData()
    ...
    If Tipe = InputType.Tambah Then
      instance = New Persistent.StockOpname(session)
    ...
    Else
      editAssign = True
      xGrid.DataSource = Nothing
      instance = session.GetObjectByKey(Of Persistent.StockOpname)(Convert.ToInt64(IdToEdit))
  ...
  Overrides Sub LoadAfterInitialize()
    SetFormat()
    If Tipe = InputType.Tambah Then
      Me.Text = "Stock Opname : Tambah"
    Else
      Me.Text = "Stock Opname : Edit " & instance.Kode
  ...
  Overrides Sub SimpanData()
    ...
    Catch ex As Exception
      ...
      End If
    End Try
    'Dim frm As New RF_DataDataTransaksi(Persistent.SumberDataJenis.OS)
    'frm.txtNoBukti1.Text = instance.Kode
    'Dim message As String = "Apakah anda ingin mencetak bukti {0} dengan nomor " & instance.Kode & " ?"
    'Dim reportCode As String = ""
    'reportCode = MainClass.GetReport(MainClass.reportName.vou)
    'message = String.Format(message, "Stock Opname")
  ...
  Private Sub SetFormat()
    ...
    'colQty.DisplayFormat.FormatString = "n2" 'NuSoft001.Logic.FinaSetting.
  End Sub
  Private Sub LoadDefault()
    ...
    instance.Tanggal = txtTanggal.DateTime
    instance.Regional = CType(txtRegional.EditValue, NPO.Modules.ModSys.Regional)
    txtUraian.EditValue = settinginventory.UraianStockOpname
  End Sub
  Private Sub SetNomor()
    instance.Sumber = sumber.GetObject(Persistent.SumberDataJenis.OS)
  ...
  Private Sub xGridView_CellValueChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles xGridView.CellValueChanged
    If Not e.Value Is Nothing Then
      If e.Column Is colKodeBarang Then
        Dim row As Persistent.StockOpnameDetail = CType(xGridView.GetRow(e.RowHandle), Persistent.StockOpnameDetail)
  ...
  Private Sub xGridView_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles xGridView.KeyDown
    If e.KeyCode = Windows.Forms.Keys.Delete Then
      Dim Id As Persistent.StockOpnameDetail = CType(xGridView.GetRow(xGridView.FocusedRowHandle), Persistent.StockOpnameDetail)
