...
Public Class UI_zPemakaianStock
  ...
  Overrides Sub FirstLoad()
    ...
    If My.Computer.FileSystem.FileExists(Logic.Umum.xLokasiLayout("zCSData.xml")) = True Then
      xGridView.RestoreLayoutFromXml(Logic.Umum.xLokasiLayout("zCSData.xml"))
    End If

  End Sub
  Overrides Function GetDialogForm() As Core.Win.Forms.InputBase
    Return New UI_zPemakaianStockDialog
  End Function
  ...
  Overrides Sub GridViewColumnWidthChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.ColumnEventArgs)
    xGridView.SaveLayoutToXml(Logic.Umum.xLokasiLayout("zCSData.xml"))
  End Sub
End Class