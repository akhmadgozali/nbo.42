...
Friend Class UI_zPemakaianStockDialog
  ...
  Overrides Sub LoadBeforeInitialize()
    ...
    If My.Computer.FileSystem.FileExists(Logic.Umum.xLokasiLayout("zCSTransaksi.xml")) = True Then
      lytTransaksi.RestoreLayoutFromXml(Logic.Umum.xLokasiLayout("zCSTransaksi.xml"))
    End If
  End Sub
  ...
  Private Sub LoadDefault()
    ...
    txtGudang.EditValue = NuSoft.Core.Win.Component.XtraLookUpEdit.GetFirstValue(txtGudang)
  End Sub
