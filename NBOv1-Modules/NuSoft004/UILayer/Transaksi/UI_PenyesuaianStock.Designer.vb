...
Partial Class UI_PenyesuaianStock
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(UI_PenyesuaianStock))
    ...
    'xGridView
    '
    Me.xGridView.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colId, Me.colTahun, Me.colBulan, Me.colCode, Me.colTanggal, Me.colTipe, Me.colKaryawan, Me.colGudang, Me.colCatatan1, Me.colStatusTransaksi1})
    ...
    Me.Name = "UI_PenyesuaianStock"
    Me.Text = "Penyesuaian Stock Data"
    Me.xpCol = Me.xpCol
