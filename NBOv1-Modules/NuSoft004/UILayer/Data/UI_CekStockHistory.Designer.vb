...
Partial Class UI_CekStockHistory
  Inherits Core.Win.Forms.BlankForm
    ...
    Me.colQtyHPPReff = New DevExpress.XtraGrid.Columns.GridColumn()
    ...
    'ifSource
    '
    Me.ifSource.DisplayableProperties = "Id;Main.Kode;Main.Tanggal;Main.Gudang.Kode;Barang.Kode;Barang.Nama;Satuan.Kode;Qt" & _
    "yIn;QtyOut;Gudang.Kode;Catatan;Stock;Main.KaryawanKirim.Nama;Main.NamaKontak;Qty" & _
    "HPPReff"
    Me.ifSource.ObjectType = GetType(NuSoft.NUI.Win.Forms.Modules.NuSoft004.Persistent.StockDetail)
    '
    'xGridView
    '
    Me.xGridView.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.GridColumn1, Me.GridColumn2, Me.colKaryawan, Me.GridColumn3, Me.GridColumn4, Me.GridColumn7, Me.GridColumn5, Me.colQtyIn, Me.colQtyOut, Me.colStock, Me.colQtyHPPReff})
    ...
    Me.colStock.VisibleIndex = 9
    '
    'colQtyHPPReff
    '
    Me.colQtyHPPReff.Caption = "Qty HPP"
    Me.colQtyHPPReff.FieldName = "QtyHPPReff"
    Me.colQtyHPPReff.Name = "colQtyHPPReff"
    Me.colQtyHPPReff.Visible = True
    Me.colQtyHPPReff.VisibleIndex = 10
    '
    'UI_CekStockHistory
    '
    Me.AllowMdiBar = True
  ...
  Friend WithEvents colQtyHPPReff As DevExpress.XtraGrid.Columns.GridColumn
End Class
