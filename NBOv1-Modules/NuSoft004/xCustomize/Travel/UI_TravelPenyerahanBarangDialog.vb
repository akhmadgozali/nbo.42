...
Imports NuSoft.NUI.Win.Forms.Modules.NuSoft004.Logic

Friend Class UI_TravelPenyerahanBarangDialog
	...
	Private settingInventory As InventorySetting
	...
	Overrides Sub LoadBeforeInitialize()
		...
		settingInventory = New InventorySetting(session)
		BindingDataSource()
	...
	Overrides Sub LoadAfterInitialize()
		SetFormat()
		If Tipe = InputType.Tambah Then
			Me.Text = "Penyerahan Barang : Tambah"
		Else
			Me.Text = "Penyerahan Barang : Edit " & instance.Kode
	...
	Overrides Sub SimpanData()
		...
		Try
			If txtGudang.EditValue Is Nothing Then
				Throw New Utils.Exception("Silahkan masukkan gudang terlebih dahulu")
			End If
			...
			For pK = 0 To instance.Detail.Count - 1
				If instance.Detail(pK).Barang.Jenis <> NuSoft004.Persistent.JenisBarang.Jasa Then
					If instance.Detail(pK).QtyOut > instance.Detail(pK).HPPReff.Sum(Function(m) m.Qty) Then
						Throw New Utils.Exception("HPP Barang : " & instance.Detail(pK).Barang.Nama & " [" & instance.Detail(pK).Barang.Kode & "] tidak tersedia." & vbCrLf &
																			 " Qty Transaksi : " & instance.Detail(pK).QtyOut.ToString("n2") & vbCrLf &
																			 " Qty HPP : " & instance.Detail(pK).HPPReff.Sum(Function(m) m.Qty).ToString("n2"), -99, "", "")
						Exit Sub
					End If
				End If
			Next
		...
		Catch ex As Exception
			...
			End If
		End Try
		'Dim frm As New RF_DataDataTransaksi(Persistent.SumberDataJenis.CS)
		'frm.txtNoBukti1.Text = instance.Kode
		'Dim message As String = "Apakah anda ingin mencetak bukti {0} dengan nomor " & instance.Kode & " ?"
		'Dim reportCode As String = ""
		'reportCode = MainClass.GetReport(MainClass.reportName.VoucherPemakaianBarang)
		'message = String.Format(message, "Pemakaian Stock")
	...
	Private Sub BindingDataSource()
		...
		colKodeBarangRepo.DataSource = New XPCollection(Of Persistent.Barang)(session, New BinaryOperator(NameOf(Barang.Jenis), JenisBarang.Persediaan, BinaryOperatorType.Equal))
	...
	Private Sub LoadDefault()
		...
		txtUraian.Text = settingInventory.UraianPemakaianBarang
	End Sub
