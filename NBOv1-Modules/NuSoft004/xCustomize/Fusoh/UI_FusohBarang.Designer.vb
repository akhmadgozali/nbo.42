...
Partial Class UI_FusohBarang
	...
	Private Sub InitializeComponent()
		Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(UI_FusohBarang))
		...
		Me.colBatangTitipan = New DevExpress.XtraGrid.Columns.GridColumn()
		Me.colLengthCutting = New DevExpress.XtraGrid.Columns.GridColumn()
		Me.colIDCutting = New DevExpress.XtraGrid.Columns.GridColumn()
		Me.colODCutting = New DevExpress.XtraGrid.Columns.GridColumn()
		Me.colThicknessCutting = New DevExpress.XtraGrid.Columns.GridColumn()
		...
		Me.xpCol.ObjectType = GetType(NuSoft.NUI.Win.Forms.Modules.NuSoft004.Persistent.Fusoh_Barang)
		'
		'barMan
		'
		...
		Me.xGridView.SortInfo.AddRange(New DevExpress.XtraGrid.Columns.GridColumnSortInfo() {New DevExpress.XtraGrid.Columns.GridColumnSortInfo(Me.colTipeBarang, DevExpress.Data.ColumnSortOrder.Ascending), New DevExpress.XtraGrid.Columns.GridColumnSortInfo(Me.colBatangTitipan, DevExpress.Data.ColumnSortOrder.Ascending)})
		'
		'barMenu
		'
		...
		Me.colInDiameter.Visible = True
		Me.colInDiameter.VisibleIndex = 4
		'
		'colOutDiameter
		'
		Me.colOutDiameter.FieldName = "OutDiameter"
		Me.colOutDiameter.Name = "colOutDiameter"
		Me.colOutDiameter.Visible = True
		Me.colOutDiameter.VisibleIndex = 5
		'
		'colLength
		'
		...
		Me.colThickness.VisibleIndex = 7
		'
		'GridColumn1
		'
		Me.GridColumn1.Caption = "Nama Customer"
		Me.GridColumn1.FieldName = "Customer.Nama"
		...
		'colBatangTitipan
		'
		Me.colBatangTitipan.Caption = "Titipan"
		Me.colBatangTitipan.FieldName = "BatangTitipan"
		Me.colBatangTitipan.Name = "colBatangTitipan"
		Me.colBatangTitipan.Visible = True
		Me.colBatangTitipan.VisibleIndex = 1
		'
		'colLengthCutting
		'
		Me.colLengthCutting.Caption = "Length Cutting"
		Me.colLengthCutting.DisplayFormat.FormatString = "n2"
		Me.colLengthCutting.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
		Me.colLengthCutting.FieldName = "LengthCutting"
		Me.colLengthCutting.Name = "colLengthCutting"
		Me.colLengthCutting.Visible = True
		Me.colLengthCutting.VisibleIndex = 9
		'
		'colIDCutting
		'
		Me.colIDCutting.Caption = "ID Cutting"
		Me.colIDCutting.DisplayFormat.FormatString = "n2"
		Me.colIDCutting.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
		Me.colIDCutting.FieldName = "IDCutting"
		Me.colIDCutting.Name = "colIDCutting"
		Me.colIDCutting.Visible = True
		Me.colIDCutting.VisibleIndex = 10
		'
		'colODCutting
		'
		Me.colODCutting.Caption = "OD Cutting"
		Me.colODCutting.DisplayFormat.FormatString = "n2"
		Me.colODCutting.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
		Me.colODCutting.FieldName = "ODCutting"
		Me.colODCutting.Name = "colODCutting"
		Me.colODCutting.Visible = True
		Me.colODCutting.VisibleIndex = 11
		'
		'colThicknessCutting
		'
		Me.colThicknessCutting.Caption = "Thickness Cutting"
		Me.colThicknessCutting.DisplayFormat.FormatString = "n2"
		Me.colThicknessCutting.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
		Me.colThicknessCutting.FieldName = "ThicknessCutting"
		Me.colThicknessCutting.Name = "colThicknessCutting"
		Me.colThicknessCutting.Visible = True
		Me.colThicknessCutting.VisibleIndex = 12
		'
		'UI_FusohBarang
		'
		Me.AutoScaleDimensions = New System.Drawing.SizeF(6.0!, 13.0!)
		Me.ClientSize = New System.Drawing.Size(759, 395)
		Me.Name = "UI_FusohBarang"
  ...
  Friend WithEvents colBatangTitipan As DevExpress.XtraGrid.Columns.GridColumn
  Friend WithEvents colLengthCutting As DevExpress.XtraGrid.Columns.GridColumn
	Friend WithEvents colIDCutting As DevExpress.XtraGrid.Columns.GridColumn
	Friend WithEvents colODCutting As DevExpress.XtraGrid.Columns.GridColumn
	Friend WithEvents colThicknessCutting As DevExpress.XtraGrid.Columns.GridColumn
End Class
