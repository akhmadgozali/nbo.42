...
Friend Class UI_SanYuBarangDialog
  Private instance As Persistent.SanYu_Barang
  ...
  Public Overrides Sub LoadAfterInitialize()
    ...
    If Tipe = InputType.Tambah Then
      Me.Text = "Item: Tambah"
      instance = New Persistent.SanYu_Barang(session)
    ...
    Else
      instance = session.GetObjectByKey(Of Persistent.SanYu_Barang)(CType(IdToEdit, Int64))
      ...
      txtKITE.EditValue = instance.KITE
  ...
  Private Sub BindingDataSource()
    ...
    colKodeBarangRepo.DataSource = New XPCollection(Of Persistent.SanYu_Barang)(session)
  ...
  Private Sub xGridPenyusunView_CellValueChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles xGridPenyusunView.CellValueChanged
    If Not e.Value Is Nothing Then
      Dim row As Persistent.SanYu_BarangAssembly = CType(xGridPenyusunView.GetRow(e.RowHandle), Persistent.SanYu_BarangAssembly)
