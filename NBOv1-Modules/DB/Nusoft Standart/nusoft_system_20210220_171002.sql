...
--
-- Host: localhost    Database: nusoft_system
-- ------------------------------------------------------
...
INSERT INTO `datalog_amain` VALUES (1,'2021-02-20 14:59:43','NuSoft - NuSoft Administrator',1,'Edit Data: dblist','Microsoft Windows 7 Home Premium |6.1.7601.65536|1.1.0.1','localhost','EASERVER-PC'),(2,'2021-02-20 17:09:23','NuSoft - NuSoft Administrator',1,'Edit Data: dblist','Microsoft Windows 7 Home Premium |6.1.7601.65536|1.1.0.1','localhost','EASERVER-PC');
...
INSERT INTO `datalog_bdetail` VALUES (1,1,'NamaDatabase','nusoft_x01','nusoft_db1'),(2,2,'NamaAlias','nusoft_x01','Nusoft');
...
INSERT INTO `dblist` VALUES (1,'Nusoft','Nusoft','nusoft_db1',1,'2014-06-20 09:30:57','Jali','2021-02-20 17:09:23','NuSoft - NuSoft Administrator');
...
--
-- Table structure for table `xyzuserlogin`
--

DROP TABLE IF EXISTS `xyzuserlogin`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `xyzuserlogin` (
  `user_id` int(10) unsigned NOT NULL,
  `user_guid` char(36) NOT NULL,
  `login_date` datetime NOT NULL,
  `user_agent` varchar(255) NOT NULL,
  `user_hostaddress` varchar(100) NOT NULL,
  `user_hostname` varchar(100) NOT NULL,
  `last_activity` datetime NOT NULL,
  PRIMARY KEY (`user_id`),
  UNIQUE KEY `code` (`user_guid`),
  KEY `fk_userlogin_user_idx` (`user_id`),
  CONSTRAINT `fk_userlogin_user` FOREIGN KEY (`user_id`) REFERENCES `userlist` (`p_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `xyzuserlogin`
--

LOCK TABLES `xyzuserlogin` WRITE;
/*!40000 ALTER TABLE `xyzuserlogin` DISABLE KEYS */;
/*!40000 ALTER TABLE `xyzuserlogin` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-02-20 17:10:03
