...
{
	public partial class UI_RealisasiCuti : GridInput
	{
		public UI_RealisasiCuti()
		{
			InitializeComponent();
			ActivateToolTip = false;
			baseView = xGridView;
			KeyField = nameof(RealisasiCuti.Id);
			useFeedbackSource = true;
			useMDIforDialog = false;
			UseDbSystem = false;
		}
		public override InputBase GetDialogForm() { return new UI_RealisasiCutiDialog(); }
	}
}
