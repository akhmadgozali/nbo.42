...
{
	public partial class UI_LiburPengganti : GridInput
	{
		public UI_LiburPengganti()
		{
			InitializeComponent();
			ActivateToolTip = false;
			baseView = xGridView;
			KeyField = nameof(Ijin.Id);
			useFeedbackSource = true;
			useMDIforDialog = false;
			UseDbSystem = false;
		}
		public override InputBase GetDialogForm() { return new UI_LiburPenggantiDialog(); }
	}
}
