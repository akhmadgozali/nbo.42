...
{
	partial class UI_SuratPeringatan
	{
		/// <summary>
    ...
    "gal;Karyawan.Id;Karyawan.Kode;Karyawan.Nama;Jenis;Expired;Keterangan";
			this.ifSource.ObjectType = typeof(NuSoft.NUI.Win.Forms.Modules.NuSoft09.Persistent.SuratPeringatan);
			// 
			// barMenu
			// 
			...
			this.colExpired.VisibleIndex = 5;
			// 
			// colKeterangan
			// 
