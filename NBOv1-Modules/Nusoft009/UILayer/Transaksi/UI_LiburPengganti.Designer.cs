...
{
	partial class UI_LiburPengganti
	{
		/// <summary>
    ...
    "gal;Karyawan.Id;Karyawan.Kode;Karyawan.Nama;TanggalAwal;TanggalAkhir;Keterangan;" +
    "JumlahHari";
			this.ifSource.ObjectType = typeof(NuSoft.NUI.Win.Forms.Modules.NuSoft09.Persistent.LiburPengganti);
			// 
			// barMenu
			// 
			...
			this.colJumlahHari.VisibleIndex = 7;
			// 
			// UI_LiburPengganti
			// 
			...
			this.Name = "UI_LiburPengganti";
			this.Text = "Libur Pengganti";
