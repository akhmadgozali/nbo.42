...
{
	public partial class UI_MutasiKaryawan : GridInput
	{
		public UI_MutasiKaryawan()
		{
			InitializeComponent();
			ActivateToolTip = false;
			baseView = xGridView;
			KeyField = nameof(PromosiKaryawan.Id);
			useFeedbackSource = true;
			useMDIforDialog = false;
			UseDbSystem = false;
		}
		public override InputBase GetDialogForm() { return new UI_MutasiKaryawanDialog(); }
	}
}
