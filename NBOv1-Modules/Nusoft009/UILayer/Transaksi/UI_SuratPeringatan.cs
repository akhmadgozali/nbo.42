...
{
	public partial class UI_SuratPeringatan : GridInput
	{
		public UI_SuratPeringatan()
		{
			InitializeComponent();
			ActivateToolTip = false;
			baseView = xGridView;
			KeyField = nameof(SuratPeringatan.Id);
			useFeedbackSource = true;
			useMDIforDialog = false;
			UseDbSystem = false;
		}
		public override InputBase GetDialogForm() { return new UI_SuratPeringatanDialog(); }
	}
}
