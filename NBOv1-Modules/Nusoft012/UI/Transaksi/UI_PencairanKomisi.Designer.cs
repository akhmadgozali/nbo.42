...
{
	partial class UI_PencairanKomisi
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			// ifSource
			// 
			this.ifSource.DisplayableProperties = "Id;Regional.Nama;NoBukti;Tanggal;CaraBayar.Alias;Sales.Nama;Keterangan;GLId.Kode;" +
    "Tahun;Bulan;JumlahPencairan";
			this.ifSource.ObjectType = typeof(NuSoft.NUI.Win.Forms.Modules.NuSoft012.Persistent.PencairanKomisi);
			// 
			// barMenu
			// 
			...
			// colNama
			// 
			this.colNama.Caption = "Sales";
			this.colNama.FieldName = "Sales.Nama";
			...
			this.Name = "UI_PencairanKomisi";
			this.Text = "Pencairan Komisi";
