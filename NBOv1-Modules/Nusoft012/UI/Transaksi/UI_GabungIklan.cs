...
namespace NuSoft.NUI.Win.Forms.Modules.NuSoft012.UI.Transaksi {
	public partial class UI_GabungIklan : GridInput {
		public UI_GabungIklan() {
			InitializeComponent();
		...
		public override InputBase GetDialogForm() { return new UI_GabungIklanDialog(); }
		...
		public override bool HapusData(List<GridDeletedData> selectedData) {
			var service = new GabungInvoiceService(session);
