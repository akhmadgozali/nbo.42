...
namespace NuSoft.NUI.Win.Forms.Modules.NuSoft012.UI.Transaksi {
	public partial class UI_BatalBayar : GridInput {
		public UI_BatalBayar() { 
			InitializeComponent();
			//ds.FixedFilterCriteria = new NotOperator(new NullOperator(nameof(PembayaranIklanTV.KoreksiPembayaran)));
		...
		public override InputBase GetDialogForm() { return new UI_BatalBayarDialog(); }
