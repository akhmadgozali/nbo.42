namespace NuSoft.NUI.Win.Forms.Modules.NuSoft012.UI.MasterData
{
	partial class UI_CaraBayar
	{
		...
		private void InitializeComponent()
		{
			...
			this.colIsPPh23 = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colIsPPh21 = new DevExpress.XtraGrid.Columns.GridColumn();
			...
			// ifSource
			// 
			this.ifSource.DisplayableProperties = "Id;Akun.Kode;Akun.Nama;Alias;Aktif;Keterangan;IsPPh23;IsPPh21";
			this.ifSource.ObjectType = typeof(NuSoft.NUI.Win.Forms.Modules.NuSoft012.Persistent.CaraBayar);
			// 
			// barMenu
			// 
			...
			this.colAktif.Width = 36;
			// 
			// colIsPPh23
			// 
			this.colIsPPh23.FieldName = "IsPPh23";
			this.colIsPPh23.Name = "colIsPPh23";
			this.colIsPPh23.Visible = true;
			this.colIsPPh23.VisibleIndex = 4;
			this.colIsPPh23.Width = 50;
			// 
			// colIsPPh21
			// 
			this.colIsPPh21.FieldName = "IsPPh21";
			this.colIsPPh21.Name = "colIsPPh21";
			this.colIsPPh21.Visible = true;
			this.colIsPPh21.VisibleIndex = 5;
			this.colIsPPh21.Width = 50;
			// 
			// UI_CaraBayar
			// 
		...
		private DevExpress.XtraGrid.Columns.GridColumn colIsPPh23;
		private DevExpress.XtraGrid.Columns.GridColumn colIsPPh21;
	}
}
