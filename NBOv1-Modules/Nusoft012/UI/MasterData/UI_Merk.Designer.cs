namespace NuSoft.NUI.Win.Forms.Modules.NuSoft012.UI.MasterData
{
	partial class UI_Merk
	{
		...
		private void InitializeComponent()
		{
			...
			// ifSource
			// 
			this.ifSource.DisplayableProperties = "Id;Produk.Nama;Kode;Nama;Keterangan";
			this.ifSource.ObjectType = typeof(NuSoft.NUI.Win.Forms.Modules.NuSoft012.Persistent.Merk);
			// 
			// barMenu
			// 
			...
			this.colProduk.FieldName = "Produk.Nama";
			this.colProduk.Name = "colProduk";
			this.colProduk.Visible = true;
			this.colProduk.VisibleIndex = 1;
			// 
			// colKode
			// 
