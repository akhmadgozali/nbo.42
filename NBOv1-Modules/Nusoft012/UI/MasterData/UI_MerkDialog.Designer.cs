namespace NuSoft.NUI.Win.Forms.Modules.NuSoft012.UI.MasterData
{
	partial class UI_MerkDialog
	{
		...
		private void InitializeComponent()
		{
			...
			this.txtProduk = new DevExpress.XtraEditors.LookUpEdit();
			...
			this.txtProduk.Location = new System.Drawing.Point(80, 12);
			this.txtProduk.Name = "txtProduk";
			this.txtProduk.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.txtProduk.Properties.Columns.AddRange(new DevExpress.XtraEditors.Controls.LookUpColumnInfo[] {
			...
			this.txtProduk.Properties.DisplayMember = "Nama";
			this.txtProduk.Properties.NullText = "[ Pilih Produk ]";
			this.txtProduk.Properties.ValueMember = "This";
			this.txtProduk.Size = new System.Drawing.Size(284, 20);
			...
			this.layoutControlItem1.Control = this.txtProduk;
			this.layoutControlItem1.CustomizationFormText = "Produk";
			this.layoutControlItem1.Location = new System.Drawing.Point(0, 0);
			this.layoutControlItem1.Name = "layoutControlItem1";
			this.layoutControlItem1.Size = new System.Drawing.Size(356, 24);
			this.layoutControlItem1.Text = "Produk";
		...
		private DevExpress.XtraEditors.LookUpEdit txtProduk;
