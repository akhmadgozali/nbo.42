namespace NuSoft.NUI.Win.Forms.Modules.NuSoft012.UI.MasterData
{
	partial class UI_Produk
	{
		...
		private void InitializeComponent()
		{
			...
			// ifSource
			// 
			this.ifSource.DisplayableProperties = "Id;Kode;Nama;Keterangan";
			this.ifSource.ObjectType = typeof(NuSoft.NUI.Win.Forms.Modules.NuSoft012.Persistent.Produk);
			// 
			// barMenu
			// 
