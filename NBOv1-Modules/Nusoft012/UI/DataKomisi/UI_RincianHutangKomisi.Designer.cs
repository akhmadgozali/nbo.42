...
{
	partial class UI_RincianHutangKomisi
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			// colKomisiCashback
			// 
			this.colKomisiCashback.Caption = "Komisi";
			...
			// 
			// UI_RincianHutangKomisi
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.ClientSize = new System.Drawing.Size(888, 405);
			this.Name = "UI_RincianHutangKomisi";
			this.Text = "Rincian Hutang Komisi";
