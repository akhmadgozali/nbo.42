...
{
	partial class UI_RincianKomisi
	{
		/// <summary> 
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(UI_RincianKomisi));
			...
			this.ifSource.FixedFilterString = "[Lunas] = True And [KomisiNominal] > 0.0m";
            ...
            new DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "KomisiNominal", null, "| Total Komisi : {0:n0}")});
			...
			this.Name = "UI_RincianKomisi";
			this.Text = "Rincian Komisi";
