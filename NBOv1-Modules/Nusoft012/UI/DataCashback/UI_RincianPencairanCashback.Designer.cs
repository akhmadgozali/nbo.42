...
{
	partial class UI_RincianPencairanCashback
	{
		/// <summary> 
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(UI_RincianPencairanCashback));
			...
			this.ifSource.ObjectType = typeof(NuSoft.NUI.Win.Forms.Modules.NuSoft012.Persistent.PencairanCashbackDetail);
			// 
			// xGrid
			// 
			...
			this.colTahun.FieldName = "PencairanCashback.Tahun";
			...
			this.colBulan.FieldName = "PencairanCashback.Bulan";
			...
			this.colNoBukti.FieldName = "PencairanCashback.NoBukti";
			...
			this.colTanggal.FieldName = "PencairanCashback.Tanggal";
			...
			this.colCaraBayar.FieldName = "PencairanCashback.CaraBayar.Alias";
			...
			this.colKeterangan.FieldName = "Cashback.Invoice.InvoiceKeterangan";
			...
			this.colNomorInvoice.FieldName = "Cashback.Invoice.NoInvoice";
			...
			this.colRegional.FieldName = "PencairanCashback.Regional.Nama";
			...
			this.colWilayah.FieldName = "Cashback.Invoice.Wilayah.Nama";
			...
			this.colPemasang.FieldName = "PencairanCashback.Pemasang";
			...
			this.colSales.FieldName = "Cashback.Invoice.Sales.Nama";
			...
			this.colTipeInvoice.FieldName = "Cashback.Invoice.TipeInvoice.Nama";
			...
			// 
			// UI_RincianPencairanCashback
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.ClientSize = new System.Drawing.Size(888, 405);
			this.Name = "UI_RincianPencairanCashback";
			this.Text = "Rincian Pencairan Cashback";
