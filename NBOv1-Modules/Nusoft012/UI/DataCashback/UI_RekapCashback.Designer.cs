...
{
	partial class UI_RekapCashback
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.fieldCashbackNominal = new DevExpress.XtraPivotGrid.PivotGridField();
			...
			// xpCol
			// 
			this.xpCol.CriteriaString = "[Lunas] = True And [CashbackNominal] > 0.0m";
			this.xpCol.DisplayableProperties = "This;Pembayaran.Tanggal;Pembayaran.Minggu;Lunas;CashbackNominal;Invoice.InvoiceNa" +
    "ma;Invoice.TipeInvoice.Nama;Invoice.Wilayah.Nama;Invoice.Wilayah.Regional.Nama";
			...
			pivotGridGroup2.Fields.Add(this.fieldPemasang);
			...
			// fieldPemasang
			// 
			this.fieldPemasang.Area = DevExpress.XtraPivotGrid.PivotArea.RowArea;
			...
			// 
			// fieldCashbackNominal
			// 
			this.fieldCashbackNominal.Area = DevExpress.XtraPivotGrid.PivotArea.DataArea;
			this.fieldCashbackNominal.AreaIndex = 0;
			this.fieldCashbackNominal.Caption = "Cashback";
			this.fieldCashbackNominal.CellFormat.FormatString = "n0";
			this.fieldCashbackNominal.CellFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
			this.fieldCashbackNominal.FieldName = "CashbackNominal";
			this.fieldCashbackNominal.Name = "fieldCashbackNominal";
			this.fieldCashbackNominal.Width = 80;
			// 
			// nChart
			// 
        ...
        series1};
			...
			chartTitle1.Text = "Rekap Cashback";
			...
			this.Name = "UI_RekapCashback";
			this.Text = "Rekap Cashback";
		...
		private DevExpress.XtraPivotGrid.PivotGridField fieldCashbackNominal;
