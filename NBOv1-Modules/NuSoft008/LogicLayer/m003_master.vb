...
Namespace Persistent
  ...
  <Persistent("m01bcontactview")> Public Class Kontak
    ...
    <Persistent("f_pembeliantermin")> Property TerminPembelian As Persistent.Termin
      ...
      End Set
    End Property
    <Persistent("f_pembeliankaryawan")> Property KaryawanPembelian As NuSoft008.Persistent.Kontak
      Get
        Return _karyawanPembelian
      End Get
      Set(value As NuSoft008.Persistent.Kontak)
        SetPropertyValue(Of NuSoft008.Persistent.Kontak)("KaryawanPembelian", _karyawanPembelian, value)
      End Set
    End Property
    ...
    <Persistent("f_penjualantermin")> Property TerminPenjualan As Persistent.Termin
      ...
      End Set
    End Property
    <Persistent("f_penjualankaryawan")> Property KaryawanPenjualan As NuSoft008.Persistent.Kontak
      Get
        Return _karyawanPenjualan
      End Get
      Set(value As NuSoft008.Persistent.Kontak)
        SetPropertyValue(Of NuSoft008.Persistent.Kontak)("KaryawanPenjualan", _karyawanPenjualan, value)
      End Set
    End Property
