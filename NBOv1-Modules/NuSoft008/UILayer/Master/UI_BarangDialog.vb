...
Friend Class UI_BarangDialog
  ...
  Overrides Sub LoadBeforeInitialize()
    If My.Computer.FileSystem.FileExists(Logic.Umum.xLokasiLayout("masterItem.xml")) = True Then
      lytMaster.RestoreLayoutFromXml(Logic.Umum.xLokasiLayout("masterItem.xml"))
    End If
  End Sub
  ...
  Private Sub BindingDataSource()
    ...
    txtSatuanDasar.Properties.DataSource = New XPCollection(Of Persistent.Satuan)(session)
    ...
    txtAkunHPP.Properties.DataSource = NuSoft001.Logic.Coa.GetCoa(session, True, New NuSoft001.Persistent.CoaEnum.eKind() {NuSoft001.Persistent.CoaEnum.eKind.HargaPokokPenjualan, NuSoft001.Persistent.CoaEnum.eKind.BiayaOperasional})
    ...
    txtPajakIn.Properties.DataSource = New XPCollection(Of Persistent.Pajak)(session)
    txtPajakOut.Properties.DataSource = New XPCollection(Of Persistent.Pajak)(session)
