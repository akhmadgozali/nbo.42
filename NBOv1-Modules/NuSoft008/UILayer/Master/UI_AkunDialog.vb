Friend Class UI_AkunDialog
  ...
  If My.Computer.FileSystem.FileExists(Logic.Umum.xLokasiLayout("masterAkun.xml")) = True Then
   lytMasterAkun.RestoreLayoutFromXml(Logic.Umum.xLokasiLayout("masterAkun.xml"))
  End If
 End Sub
