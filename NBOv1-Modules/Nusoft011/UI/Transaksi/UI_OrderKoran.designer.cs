namespace NuSoft.NUI.Win.Forms.Modules.NuSoft011.UI.Transaksi
{
	partial class UI_OrderKoran
	{
		...
		private void InitializeComponent()
		{
			...
			// ifSource
			// 
			this.ifSource.DisplayableProperties = "Id;Tanggal;HariKhusus;Keterangan;Tahun;Bulan;TotalOplah";
			this.ifSource.ObjectType = typeof(NuSoft.NUI.Win.Forms.Modules.NuSoft011.Persistent.OrderKoran);
			// 
			// barMenu
			// 
			...
			this.Name = "UI_OrderKoran";
			this.Text = "Order Koran";
