namespace NuSoft.NUI.Win.Forms.Modules.NuSoft011.UI.Transaksi
{
	partial class UI_EditHarga
	{
		...
		private void InitializeComponent()
		{
			...
			// ifSource
			// 
			this.ifSource.DisplayableProperties = "Id;Tahun;Bulan;JumlahHari;Keterangan";
			this.ifSource.ObjectType = typeof(NuSoft.NUI.Win.Forms.Modules.NuSoft011.Persistent.EditHarga);
			// 
			// barMenu
			// 
			...
			this.colJumlahHari.VisibleIndex = 2;
			// 
			// colKeterangan
			// 
