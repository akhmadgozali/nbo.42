...
Public Class UI_PengirimanBarang
  ...
  Overrides Function GetDialogForm() As Core.Win.Forms.InputBase
    Return New UI_PengirimanBarangDialog
  End Function
    ...
    For i = 0 To selectedData.Count - 1
      If Not xGridView.IsGroupRow(selectedData(i).Row) Then
        ...
        If xTipe = "memposting" Then
          ...
          '  xGagal += 1
          'End If
          xMessage = "Untuk memposting transaksi silahkan edit transaksi lalu ganti status menjadi posting."
          xGagal += 1
        ElseIf xTipe = "mengunposting" Then
          ...
          If item.StatusTransaksi = NuSoft001.Persistent.StatusTransaksiEnum.Posting Then
            ...
            For pX = 0 To item.Detail.Count - 1
              For pJ = item.Detail(pX).HPPReff.Count - 1 To 0 Step -1
                item.Detail(pX).HPPReff(pJ).Delete()
              Next
            Next
            'seting GL nya menjadi 0
            For pi = 0 To item.Gl.Detail.Count - 1
              item.Gl.Detail(pi).Debit = 0
              item.Gl.Detail(pi).Kredit = 0
            Next
