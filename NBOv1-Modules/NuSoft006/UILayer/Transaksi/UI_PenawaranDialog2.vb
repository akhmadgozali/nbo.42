...
Friend Class UI_PenawaranDialog2
  ...
  Overrides Sub LoadBeforeInitialize()
    ...
    txtKontak.Properties.AutoSearchColumnIndex = salesSetting.AutoSearchKontak
    BindingDataSource()
  ...
  Private Sub xGridView_CellValueChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs)
    ...
    End If
  End Sub
  Private Sub xGridView_InitNewRow(sender As Object, e As DevExpress.XtraGrid.Views.Grid.InitNewRowEventArgs)
    Dim row As Persistent.PenawaranDetail = CType(xGridView.GetRow(e.RowHandle), Persistent.PenawaranDetail)
    row.Barang = Nothing
    row.Qty = 0
    row.Main = instance
    row.Catatan = ""
  End Sub
  Private Sub xGridView_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs)
