Friend Class UI_ProyekDialog
  ...
  Public Overrides Sub LoadAfterInitialize()
    txtCustomer.Properties.DataSource = New DevExpress.Xpo.XPCollection(Of NuSoft001.Persistent.Kontak)(session)
    txtRAB.Properties.DataSource = New DevExpress.Xpo.XPCollection(Of Persistent.RAB)(session)
  ...
  Public Overrides Sub SimpanData()
    ...
    instance.RAB = CType(txtRAB.EditValue, Persistent.RAB)
    instance.Save()
