...
Partial Class UI_DPPenjualan
  ...
  Private Sub InitializeComponent()
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(UI_DPPenjualan))
    ...
    Me.colTotalDP = New DevExpress.XtraGrid.Columns.GridColumn()
    ...
    'barMan
    '
    Me.barMan.Items.AddRange(New DevExpress.XtraBars.BarItem() {Me.btnUpdate, Me.btnPosting, Me.btnUnposting, Me.btnClosing, Me.btnSaveLayout, Me.btnVoucher})
    Me.barMan.MaxItemId = 19
    '
    'xGridView
    '
    Me.xGridView.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colId, Me.colTahun, Me.colBulan, Me.colKode, Me.colTanggal, Me.colVendor, Me.colUang, Me.colValas, Me.colKurs, Me.colTotalDP, Me.colStatus, Me.colKeterangan, Me.GridColumn46, Me.GridColumn47})
    ...
    Me.ifSource.ObjectType = GetType(NuSoft.NUI.Win.Forms.Modules.NuSoft006.Persistent.DPPenjualan)
    '
    'popMenu
    '
    Me.popMenu.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() {New DevExpress.XtraBars.LinkPersistInfo(DevExpress.XtraBars.BarLinkUserDefines.PaintStyle, Me.btnVoucher, "", True, True, True, 0, Nothing, DevExpress.XtraBars.BarItemPaintStyle.CaptionGlyph)})
    '
    'barMenu
    '
    ...
    Me.colVendor.FieldName = "Pelanggan.Nama"
    ...
    'colValas
    '
    Me.colValas.Caption = "Nilai Valas"
    Me.colValas.FieldName = "DPValas"
    Me.colValas.Name = "colValas"
    Me.colValas.Visible = True
    Me.colValas.VisibleIndex = 5
    '
    'colUang
    '
    ...
    'colTotalDP
    '
    Me.colTotalDP.Caption = "Total DP"
    Me.colTotalDP.FieldName = "NilaiDP"
    Me.colTotalDP.Name = "colTotalDP"
    Me.colTotalDP.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum)})
    Me.colTotalDP.Visible = True
    Me.colTotalDP.VisibleIndex = 8
    '
    'colKurs
    '
    ...
    'GridColumn46
    '
    Me.GridColumn46.Caption = "Nomor SO"
    Me.GridColumn46.FieldName = "SO.Kode"
    ...
    'GridColumn47
    '
    Me.GridColumn47.Caption = "Tanggal SO"
    Me.GridColumn47.FieldName = "SO.Tanggal"
    ...
    Me.Name = "UI_DPPenjualan"
    Me.Text = "DP Penjualan [DP]"
    Me.xpCol = Me.xpCol
  ...
  Friend WithEvents colTotalDP As DevExpress.XtraGrid.Columns.GridColumn
