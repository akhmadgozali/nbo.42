...
Partial Class UI_InvoicePenjualan2
  ...
  Private Sub InitializeComponent()
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(UI_InvoicePenjualan2))
    ...
    'barMan
    '
    Me.barMan.Items.AddRange(New DevExpress.XtraBars.BarItem() {Me.btnUpdate, Me.btnPosting, Me.btnUnposting, Me.btnClosing, Me.BarButtonItem4, Me.btnSaveLayout, Me.btnCetakVoucher1, Me.btnVoucher, Me.btnCetakVoucher2, Me.btnCetakVoucher3, Me.btnShowVoucher})
    Me.barMan.MaxItemId = 24
    '
    'xGridView
    '
    Me.xGridView.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colId, Me.colKode, Me.colTanggal, Me.colCustomer, Me.colUang, Me.colKurs, Me.colStatus})
    ...
    'ifSource
    '
    Me.ifSource.DisplayableProperties = "id;u_code;d_date;f_customer.Kode;f_customer.Nama;f_currency.Kode;f_currency.Nama;" & _
    "d_kurs;d_status"
    Me.ifSource.ObjectType = GetType(NuSoft.NUI.Win.Forms.Modules.NuSoft006.Persistent.vwInvoiceData)
    '
    'popMenu
    '
    Me.popMenu.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() {New DevExpress.XtraBars.LinkPersistInfo(Me.btnVoucher), New DevExpress.XtraBars.LinkPersistInfo(Me.btnShowVoucher), New DevExpress.XtraBars.LinkPersistInfo(Me.btnSaveLayout, True)})
    '
    'barMenu
    '
    ...
    Me.colTanggal.FieldName = "d_date"
    ...
    Me.colCustomer.FieldName = "f_customer.Nama"
    ...
    Me.colUang.FieldName = "f_currency.Kode"
