...
Namespace Persistent
  ...
  Friend Class InvoicePenjualan
    ...
    Private _tipeinvoice As Persistent.eTipeInvoicePenjualan
    ...
    <NonPersistent()> ReadOnly Property NilaiInvoice As Double
      Get
        ...
        ElseIf Sumber.Id = Persistent.SumberDataJenis.BR Then
    ...
    End Property
		...
		<PersistentAlias("Detail.Sum(TotalFeeAgen)")> ReadOnly Property TotalFeeAgen As Double
			Get
				Return Convert.ToDouble(EvaluateAlias("TotalFeeAgen"))
			End Get
		End Property
    ...
    <PersistentAlias("DetailDP.Sum(NilaiDP+NilaiPajak)")> ReadOnly Property NilaiDP As Double
      ...
      End Get
    End Property
    <PersistentAlias("DetailDP.Sum(NilaiDP)")> ReadOnly Property NilaiDPdpp As Double
      Get
        Return Convert.ToDouble(EvaluateAlias("NilaiDPdpp"))
      End Get
    End Property
    ...
    <PersistentAlias("Terbilang(Total,Uang.Nama)")> ReadOnly Property TerbilangMataUang As String
      ...
      End Get
    End Property
    <Persistent("d_tipeinvoice")> Property TipeInvoicePenjualan As Persistent.eTipeInvoicePenjualan
      Get
        Return _tipeinvoice
      End Get
      Set(value As Persistent.eTipeInvoicePenjualan)
        SetPropertyValue(Of Persistent.eTipeInvoicePenjualan)("TipeInvoicePenjualan", _tipeinvoice, value)
      End Set
    End Property
    ...
    <Association("fk_invoice_dp"), Aggregated> ReadOnly Property DetailDP As XPCollection(Of InvoicePenjualanDP)
      ...
      End Get
    End Property
    <Association("fk_pembayaran_invoice"), Aggregated> ReadOnly Property Pembayaran As XPCollection(Of PembayaranPiutangDetail)
      Get
        Return GetCollection(Of PembayaranPiutangDetail)("Pembayaran")
      End Get
    End Property
  ...
  Friend Class InvoicePenjualanDetail
    ...
    End Property
		<PersistentAlias("iif(Main.TipePajak = 2,(SubTotal) - ((PPNp - PPHp) / (100 + (PPNp - PPHp)) * (SubTotal)),SubTotal)")> ReadOnly Property DPP As Double
			...
			End Get
		End Property
		<PersistentAlias("Qty * Barang.FeeAgen")> ReadOnly Property TotalFeeAgen As Double
			Get
				Return Convert.ToDouble(EvaluateAlias("TotalFeeAgen"))
			End Get
		End Property
    ...
    End Sub
  End Class
  <Persistent("m06fdetailinvoicedp")>
  ...
  End Class
  <Persistent("m06vwaginginvoice")> Friend Class ViewInvoiceUmur
    Inherits XPLiteObject
    Public Sub New(ByVal session As Session)
      MyBase.New(session)
    End Sub
    Public Sub New(ByVal session As Session, ByVal classInfo As Metadata.XPClassInfo)
      MyBase.New(session, classInfo)
    End Sub
    <Key()> Property p_id As InvoicePenjualan
