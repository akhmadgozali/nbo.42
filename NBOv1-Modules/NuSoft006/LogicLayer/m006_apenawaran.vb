...
Namespace Persistent
	...
	Friend Class Penawaran
		...
		Property Alamat As NuSoft001.Persistent.KontakAlamat
			Get
				Return _alamat
			End Get
		...
		Property Salesman As NuSoft001.Persistent.Kontak
			Get
				Return _salesman
			End Get
			Set(value As NuSoft001.Persistent.Kontak)
		...
		<Association("fk_penawaran_detail"), Aggregated> ReadOnly Property Detail As XPCollection(Of PenawaranDetail)
			Get
				Return GetCollection(Of PenawaranDetail)("Detail")
			End Get
		End Property
		Private Function CheckData() As Boolean
			...
			End If
			If Uraian = "" Then
				Throw New Utils.Exception("Masukkan Uraian", -8, "", source)
			End If
  ...
  Friend Class PenawaranDetail
    ...
    End Sub
		...
		Private _main As Persistent.Penawaran
    ...
    Private _catatan As String
      ...
      End Set
    End Property
    <Persistent("p_id"), Association("fk_penawaran_detail")>
    Property Main As Penawaran
      Get
        Return _main
      End Get
      Set(value As Penawaran)
        SetPropertyValue(Of Penawaran)("Main", _main, value)
      End Set
    End Property
    <Persistent("f_item")>
    ...
    <NonPersistent> Property BarangLastPurchase As Double
    <NonPersistent> Property BarangFeeAgen As Double
    ...
    <Association("fk_penawarandetail_orderpenjualandetail"), Aggregated> ReadOnly Property DaftarSODetail As XPCollection(Of OrderPenjualanDetail)
      Get
        Return GetCollection(Of OrderPenjualanDetail)(NameOf(DaftarSODetail))
      End Get
    End Property
    <PersistentAlias("IsNull(" & NameOf(DaftarSODetail) & ".Sum(" & NameOf(OrderPenjualanDetail.Qty) & ") ,0)")> ReadOnly Property QtySO As Double
      Get
        Return Convert.ToDouble(EvaluateAlias(NameOf(QtySO)))
      End Get
    End Property
    <PersistentAlias(NameOf(Qty) & "-" & NameOf(QtySO))> ReadOnly Property QtyBelumSO As Double
      Get
        Return Convert.ToDouble(EvaluateAlias(NameOf(QtyBelumSO)))
      End Get
    End Property
  End Class
End Namespace