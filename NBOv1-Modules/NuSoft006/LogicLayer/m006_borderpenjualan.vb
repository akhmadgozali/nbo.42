...
Namespace Persistent
  ...
  Friend Class OrderPenjualan
    ...
    '==================== SJ ========================
    <Association("fk_OrderPenjualan_PengirimanBarang")> Public ReadOnly Property DaftarSJ As XPCollection(Of PengirimanBarang)
      Get
        Return GetCollection(Of PengirimanBarang)(NameOf(DaftarSJ))
      End Get
    End Property
  End Class
  ...
  Friend Class OrderPenjualanDetail
    ...
    <PersistentAlias("iif(Main.TipePajak = 2,(SubTotal) - ((PPNp - PPHp) / (100 + (PPNp - PPHp)) * (SubTotal)),SubTotal)")> ReadOnly Property DPP As Double
      ...
      End Get
    End Property
    <Persistent("f_idquotation"), Association("fk_penawarandetail_orderpenjualandetail")>
    ...
    '==================== SJ ========================
    <Association("fk_OrderPenjualanDetail_PengirimanBarangDetail")> Public ReadOnly Property DaftarSJDetail As XPCollection(Of PengirimanBarangDetail)
      Get
        Return GetCollection(Of PengirimanBarangDetail)(NameOf(DaftarSJDetail))
      End Get
    End Property
    <PersistentAlias(NameOf(DaftarSJDetail) & ".Sum(" & NameOf(PengirimanBarangDetail.Qty) & ")")> Public ReadOnly Property JumlahQtySJ As Double
      Get
        Return Convert.ToDouble(EvaluateAlias(NameOf(JumlahQtySJ)))
      End Get
    End Property
    <PersistentAlias(NameOf(Qty) & " - " & NameOf(JumlahQtySJ))> Public ReadOnly Property QtyBelumDikirim As Double
      Get
