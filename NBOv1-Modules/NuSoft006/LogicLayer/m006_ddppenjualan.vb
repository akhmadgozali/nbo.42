...
Namespace Persistent
  ...
  Friend Class DPPenjualan
    ...
    <NonPersistent()> ReadOnly Property NilaiDP As Double
      Get
        Return (NilaiDPpersen / 100 * SO.SubTotal) * Kurs
      End Get
    End Property
    ...
    Private Function CheckData() As Boolean
      ...
      End If
      If Uang.Id <> Uang.PiutangDagang.MataUang.Id Then
        Throw New Utils.Exception("Mata uang untuk coa [Piutang Dagang] tidak sama dengan mata uang transaksi", -7, "", source)
      End If
