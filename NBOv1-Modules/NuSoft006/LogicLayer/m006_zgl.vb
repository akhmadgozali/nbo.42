...
Namespace Persistent
  ...
  Friend Class GlMain
    ...
    Private Function CheckData() As Boolean
      Dim source As String = "General Ledger"
      ...
      Dim xsumDebit As Double = Detail.Sum(Function(m) m.Debit)
      Dim xsumKredit As Double = Detail.Sum(Function(m) m.Kredit)

      '======= Cek Nol
      'If Detail.Sum(Function(m) m.Debit) = 0 Then
      '  Dim xMessageJurnal As String = ""
      '  For i = 0 To Detail.Count - 1
      '    xMessageJurnal += i & ":" & Detail(i).Akun.Nama.ToString & " " & Detail(i).Debit.ToString & "~" & Detail(i).Kredit.ToString & vbCrLf
      '  Next

      '  Throw New Utils.Exception("Saldo tidak boleh nol" & vbCrLf & vbCrLf & "Jurnal sistem : " & vbCrLf & xMessageJurnal, -7, "Periksa lagi transaksi anda", source)
      '  Return False
      'End If
      ...
      If sumDebit.ToString("n4") <> sumKredit.ToString("n4") Then
        ...
        Throw New Utils.Exception("Debit=" & sumDebit & vbCrLf & "Kredit=" & sumKredit & vbCrLf & "Jurnal tidak seimbang" & vbCrLf & vbCrLf & "Jurnal sistem : " & vbCrLf & xMessageJurnal, -7, "Periksa lagi transaksi anda", source)
        Return False
      End If
      Return True
    End Function
  ...
  Friend Class GlMainDetail
    ...
    Private Function CheckData() As Boolean
      ...
      '  Throw New Utils.Exception("Masukkan nilai debit/kredit untuk akun " & Akun.Kode, -3, "", source)
      '  Return False
      'End If
