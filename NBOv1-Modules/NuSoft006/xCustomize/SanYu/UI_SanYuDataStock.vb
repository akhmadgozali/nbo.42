...
Public Class UI_SanyuDataStock
  ...
  Overrides Sub FirstLoad()
    ...
    Dim xDataPengiriman As New XPCollection(Of Persistent.SanYu_PengirimanBarangDetail)(session, New BinaryOperator("Main.Sumber", Persistent.SumberDataJenis.SJ, BinaryOperatorType.Equal))
    xGrid.DataSource = Nothing
    xGrid.DataSource = xDataPengiriman
  End Sub
End Class