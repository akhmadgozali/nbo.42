...
Friend Class zWoojinRF_DataDataTransaksi
  ...
  Overrides Sub InitializeData()
    Select Case _jenis
      Case Persistent.SumberDataJenis.SO
        txtNoBukti1.Properties.DataSource = New XPCollection(Of Persistent.zWoojinOrderPenjualan)(_sesi)
        txtNoBukti2.Properties.DataSource = New XPCollection(Of Persistent.zWoojinOrderPenjualan)(_sesi)
      Case Persistent.SumberDataJenis.IV
        txtNoBukti1.Properties.DataSource = New XPCollection(Of Persistent.zWoojinInvoicePenjualan)(_sesi)
        txtNoBukti2.Properties.DataSource = New XPCollection(Of Persistent.zWoojinInvoicePenjualan)(_sesi)
      Case Persistent.SumberDataJenis.CP
        txtNoBukti1.Properties.DataSource = New XPCollection(Of Persistent.zWoojinPembayaranPiutang)(_sesi)
        txtNoBukti2.Properties.DataSource = New XPCollection(Of Persistent.zWoojinPembayaranPiutang)(_sesi)
    End Select
  ...
  Overrides Sub Filter()
    ...
    Select Case _jenis
      Case Persistent.SumberDataJenis.SO
        _dataSource = New DevExpress.Xpo.XPCollection(Of Persistent.zWoojinOrderPenjualanDetail)(_sesi, CreateCriteria)
      Case Persistent.SumberDataJenis.IV
        _dataSource = New DevExpress.Xpo.XPCollection(Of Persistent.zWoojinInvoicePenjualanDetail)(_sesi, CreateCriteria)
      Case Persistent.SumberDataJenis.CP
        _dataSource = New DevExpress.Xpo.XPCollection(Of Persistent.zWoojinPembayaranPiutangDetail)(_sesi, CreateCriteria)
    End Select
  End Sub
