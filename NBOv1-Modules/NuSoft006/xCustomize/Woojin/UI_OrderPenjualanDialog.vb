...
Friend Class zWoojinUI_OrderPenjualanDialog
  Private instance As Persistent.zWoojinOrderPenjualan
  Private isShown As Boolean
  Private xpSettingRegional As XPCollection(Of NuSoft001.Persistent.SettingRegional)
  Private editAssign As Boolean = False
  Private detailToDelete As New List(Of Persistent.zWoojinOrderPenjualanDetail)
  ...
  Sub New()
    ...
    Persistent.zWoojinOrderPenjualan.AutoSaveOnEndEdit = False
    Persistent.zWoojinOrderPenjualanDetail.AutoSaveOnEndEdit = False
  ...
  Overrides Sub InitializeData()
    ...
    If Tipe = InputType.Tambah Then
      instance = New Persistent.zWoojinOrderPenjualan(session)
    ...
    Else
      editAssign = True
      xGrid.DataSource = Nothing
      instance = session.GetObjectByKey(Of Persistent.zWoojinOrderPenjualan)(Convert.ToInt64(IdToEdit))
  ...
  Overrides Sub SimpanData()
    ...
    Dim frm As New zWoojinRF_DataDataTransaksi(Persistent.SumberDataJenis.SO)
    frm.txtNoBukti1.EditValue = instance.Kode

    Dim message As String = "Apakah anda ingin mencetak bukti {0} dengan nomor " & instance.Kode & " ?"
    Dim reportCode As String = ""
    reportCode = MainClass.GetReport(MainClass.reportName.zWoojinVoucherSO)
  ...
  Private Sub BindingDataSource()
    ...
    txtProyek.Properties.DataSource = New XPCollection(Of NuSoft001.Persistent.Proyek)(session)
  ...
  Private Sub txtKontak_EditValueChanging(sender As Object, e As DevExpress.XtraEditors.Controls.ChangingEventArgs) Handles txtKontak.EditValueChanging
    If Not e.NewValue Is Nothing Then
      ...
      Dim xpTransaksi As New XPCollection(Of Persistent.zWoojinOrderPenjualan)(session, New BinaryOperator("Pelanggan", CType(e.NewValue, NuSoft001.Persistent.Kontak), BinaryOperatorType.Equal))
  ...
  Private Sub xGridView_CellValueChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles xGridView.CellValueChanged
    If Not e.Value Is Nothing Then
      Dim row As Persistent.zWoojinOrderPenjualanDetail = CType(xGridView.GetRow(e.RowHandle), Persistent.zWoojinOrderPenjualanDetail)
  ...
  Private Sub xGridView_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles xGridView.KeyDown
    If e.KeyCode = Windows.Forms.Keys.Delete Then
      Dim Id As Persistent.zWoojinOrderPenjualanDetail = CType(xGridView.GetRow(xGridView.FocusedRowHandle), Persistent.zWoojinOrderPenjualanDetail)
