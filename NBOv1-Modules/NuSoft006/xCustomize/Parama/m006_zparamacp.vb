...
Namespace Persistent
  ...
  Friend Class zParamaPembayaranPiutang
    ...
    Private _totalppn As Double
    Private _kurswapu As Double
    ...
    End Property
    <Persistent("d_wapu")>
    Property TotalPPN As Double
      Get
        Return _totalppn
      End Get
      Set(value As Double)
        SetPropertyValue(Of Double)("TotalPPN", _totalppn, value)
      End Set
    End Property
    <Persistent("d_wapukurs")>
    Property KursWapu As Double
      Get
        Return _kurswapu
      End Get
      Set(value As Double)
        SetPropertyValue(Of Double)("KursWapu", _kurswapu, value)
      End Set
    End Property
    ...
    <Persistent("f_gl")> Property Gl As GlMain
      ...
      End Set
    End Property
    <Association("fk_pembayaran_detail"), Aggregated> ReadOnly Property Detail As XPCollection(Of zParamaPembayaranPiutangDetail)
      Get
        Return GetCollection(Of zParamaPembayaranPiutangDetail)("Detail")
      End Get
    End Property
  ...
  Friend Class zParamaPembayaranPiutangDetail
    Inherits NPOBase
    Public Sub New(ByVal session As UnitOfWork)
      MyBase.New(session)
    End Sub
    ...
    Private _main As Persistent.zParamaPembayaranPiutang
    Private _idinvoice As Persistent.zParamaInvoicePenjualan
    ...
    Property Main As zParamaPembayaranPiutang
      Get
        Return _main
      End Get
      Set(value As zParamaPembayaranPiutang)
        SetPropertyValue(Of zParamaPembayaranPiutang)("Main", _main, value)
      End Set
    End Property
    <Persistent("p_idinvoice")>
    Property NoInvoice As Persistent.zParamaInvoicePenjualan
      Get
        Return _idinvoice
      End Get
      Set(value As Persistent.zParamaInvoicePenjualan)
        SetPropertyValue(Of Persistent.zParamaInvoicePenjualan)("NoInvoice", _idinvoice, value)
      End Set
    End Property
  ...
  <Persistent("m06vwinvoice")> Friend Class zParamaViewInvoice
    ...
    <Key()> Property NoInvoice As zParamaInvoicePenjualan
