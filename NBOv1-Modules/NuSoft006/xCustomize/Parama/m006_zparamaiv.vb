...
Namespace Persistent
  ...
  Friend Class zParamaInvoicePenjualan
    ...
    Private _tipeppn As Persistent.eTipePPN
    ...
    Property BiayaLain As Double
      ...
      End Set
    End Property
    <Persistent("d_tipeppn")>
    Property TipePPN As Persistent.eTipePPN
      Get
        Return _tipeppn
      End Get
      Set(value As Persistent.eTipePPN)
        SetPropertyValue(Of Persistent.eTipePPN)("TipePPN", _tipeppn, value)
      End Set
    End Property
