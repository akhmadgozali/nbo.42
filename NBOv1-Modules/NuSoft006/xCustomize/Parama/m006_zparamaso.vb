...
Namespace Persistent
  <Persistent("m06cmainorderparama")>
  Friend Class zParamaOrderPenjualan
    ...
    <PersistentAlias("Terbilang(Total,Uang.Nama)")> ReadOnly Property TerbilangMataUang As String
      ...
      End Get
    End Property
    <Association("fk_order_detail"), Aggregated> ReadOnly Property Detail As XPCollection(Of zParamaOrderPenjualanDetail)
      Get
        Return GetCollection(Of zParamaOrderPenjualanDetail)("Detail")
      End Get
    End Property
    ...
    End Sub
  End Class
  <Persistent("m06ddetailorderparama")>
  Friend Class zParamaOrderPenjualanDetail
    Inherits NPOBase
    Public Sub New(ByVal session As UnitOfWork)
      MyBase.New(session)
    End Sub
    ...
    Private _main As Persistent.zParamaOrderPenjualan
    ...
    Property Main As zParamaOrderPenjualan
      Get
        Return _main
      End Get
      Set(value As zParamaOrderPenjualan)
        SetPropertyValue(Of zParamaOrderPenjualan)("Main", _main, value)
      End Set
    End Property
    <Persistent("d_header")>
