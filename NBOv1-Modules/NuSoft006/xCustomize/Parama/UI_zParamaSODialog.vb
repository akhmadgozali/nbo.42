...
Friend Class UI_zParamaSODialog
  Private instance As Persistent.zParamaOrderPenjualan
  Private isShown As Boolean
  Private xpSettingRegional As XPCollection(Of NuSoft001.Persistent.SettingRegional)
  Private editAssign As Boolean = False
  Private detailToDelete As New List(Of Persistent.zParamaOrderPenjualanDetail)
  ...
  Sub New()
    ...
    Persistent.zParamaOrderPenjualan.AutoSaveOnEndEdit = False
    Persistent.zParamaOrderPenjualanDetail.AutoSaveOnEndEdit = False
  ...
  Overrides Sub InitializeData()
    ...
    If Tipe = InputType.Tambah Then
      instance = New Persistent.zParamaOrderPenjualan(session)
    ...
    Else
      editAssign = True
      xGrid.DataSource = Nothing
      instance = session.GetObjectByKey(Of Persistent.zParamaOrderPenjualan)(Convert.ToInt64(IdToEdit))
      ...
      txtProyek.EditValue = instance.Proyek
  ...
  Overrides Sub SimpanData()
    ...
    Try
      ...
      instance.Proyek = CType(txtProyek.EditValue, NuSoft001.Persistent.Proyek)
      instance.Save()
      '======= Simpan instance
    ...
    'Dim frm As New RF_DataDataTransaksi(Persistent.SumberDataJenis.SO)
  ...
  Private Sub SetFormat()
    colPerson.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
    colPerson.DisplayFormat.FormatString = setting.NumericFormatString
    colPerson.SummaryItem.DisplayFormat = setting.NumericFormatString
  ...
  Private Sub txtKontak_EditValueChanging(sender As Object, e As DevExpress.XtraEditors.Controls.ChangingEventArgs) Handles txtKontak.EditValueChanging
    If Not e.NewValue Is Nothing Then
      ...
      Dim xpTransaksi As New XPCollection(Of Persistent.zParamaOrderPenjualan)(session, New BinaryOperator("Pelanggan", CType(e.NewValue, NuSoft001.Persistent.Kontak), BinaryOperatorType.Equal))
      xGHistory.DataSource = xpTransaksi

      txtProyek.Properties.DataSource = New XPCollection(Of NuSoft001.Persistent.Proyek)(session, New BinaryOperator("Customer.Id", CType(e.NewValue, NuSoft001.Persistent.Kontak).Id, BinaryOperatorType.Equal))
    End If
  End Sub
  ...
  Private Sub xGridView_CellValueChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles xGridView.CellValueChanged
    If Not e.Value Is Nothing Then
      Dim row As Persistent.zParamaOrderPenjualanDetail = CType(xGridView.GetRow(e.RowHandle), Persistent.zParamaOrderPenjualanDetail)
      HitungTotal()
    End If
  End Sub
  ...
  Private Sub xGridView_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles xGridView.KeyDown
    If e.KeyCode = Windows.Forms.Keys.Delete Then
      Dim Id As Persistent.zParamaOrderPenjualanDetail = CType(xGridView.GetRow(xGridView.FocusedRowHandle), Persistent.zParamaOrderPenjualanDetail)
