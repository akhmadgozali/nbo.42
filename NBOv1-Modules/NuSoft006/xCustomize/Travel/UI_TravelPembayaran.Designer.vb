...
Partial Class UI_TravelPembayaran
  ...
  Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(UI_TravelPembayaran))
        ...
        'xGridView
        '
        Me.xGridView.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colId, Me.colTahun, Me.colBulan, Me.colKode, Me.colTanggal, Me.colCustomer, Me.colKasBank, Me.colMataUang, Me.colTotalValas, Me.colKurs, Me.colTotal, Me.colUraian})
        Me.xGridView.GroupCount = 2
        Me.xGridView.GroupSummary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Count, "Kode", Nothing, "  (Record : {0})"), New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "Total", Nothing, " (Total : {0:n0})")})
        ...
        'ifSource
        '
        Me.ifSource.DisplayableProperties = "Id;Tahun;Bulan;Urutan;Kode;Tanggal;Pelanggan.Nama;Uraian;coakasbank.Nama;Kurs;Tot" &
    "al;TotalValas;coakasbank.MataUang.Kode"
        Me.ifSource.ObjectType = GetType(NuSoft.NUI.Win.Forms.Modules.NuSoft006.Travel.Persistent.Travel_PembayaranInvoice)
        '
        'popMenu
        '
        ...
        'colTotalValas
        '
        Me.colTotalValas.Caption = "Total Valas"
        ...
        Me.colKasBank.FieldName = "coakasbank.Nama"
        Me.colKasBank.Name = "colKasBank"
        Me.colKasBank.Visible = True
        Me.colKasBank.VisibleIndex = 3
        '
        'colKurs
        '
        ...
        Me.colMataUang.FieldName = "coakasbank.MataUang.Kode"
        Me.colMataUang.Name = "colMataUang"
        Me.colMataUang.Visible = True
        Me.colMataUang.VisibleIndex = 4
        '
        'colTotal
        '
        ...
        Me.Name = "UI_TravelPembayaran"
        Me.Text = "Travel - Pembayaran Invoice [CP]"
        Me.xpCol = Me.xpCol
