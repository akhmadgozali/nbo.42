...
Public Class UI_Fusoh_SOPPIC
  ...
  Overrides Sub FirstLoad()
    ...
    Dim xFilter As New List(Of CriteriaOperator)
    ' xFilter.Add(New InOperator("Regional", UserInfo.GetUserRegional(session, NamaDatabase)))
    xFilter.Add(New BinaryOperator("StatusTransaksi", 0, BinaryOperatorType.Equal))
    xFilter.Add(New BinaryOperator("StatusTransaksi", 4, BinaryOperatorType.Equal))

    ifSource.FixedFilterCriteria = GroupOperator.Or(xFilter) 'New DevExpress.Data.Filtering.InOperator("Regional", UserInfo.GetUserRegional(session, NamaDatabase))
