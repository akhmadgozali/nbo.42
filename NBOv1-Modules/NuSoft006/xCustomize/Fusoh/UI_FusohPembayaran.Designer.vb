...
Partial Class UI_FusohPembayaran
	...
	Private Sub InitializeComponent()
        ...
        'barMan
        '
        Me.barMan.Items.AddRange(New DevExpress.XtraBars.BarItem() {Me.btnUpdate, Me.btnPosting, Me.btnUnPosting, Me.btnClosing, Me.btnSaveLayout, Me.btnCetak, Me.btnShowLog})
        ...
        Me.ifSource.ObjectType = GetType(NuSoft.NUI.Win.Forms.Modules.NuSoft006.Persistent.Fusoh_PembayaranPiutang)
        '
        'popMenu
        '
        Me.popMenu.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() {New DevExpress.XtraBars.LinkPersistInfo(Me.btnCetak), New DevExpress.XtraBars.LinkPersistInfo(Me.btnShowLog, True)})
        '
        'barMenu
        '
