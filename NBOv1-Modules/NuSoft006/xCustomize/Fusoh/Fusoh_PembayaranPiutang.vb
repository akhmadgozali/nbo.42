...
Namespace Persistent
  <Persistent("m06fmainpayment")> Friend Class Fusoh_PembayaranPiutang
    ...
    <Association("fk_pembayaran_detail"), Aggregated> ReadOnly Property Detail As XPCollection(Of Fusoh_PembayaranPiutangDetail)
      Get
        Return GetCollection(Of Fusoh_PembayaranPiutangDetail)("Detail")
      End Get
    End Property
  ...
  <Persistent("m06gdetailpayment")> Friend Class Fusoh_PembayaranPiutangDetail
    Inherits NPOBase
    ...
    Private _main As Fusoh_PembayaranPiutang
    Private _idinvoice As Fusoh_InvoicePenjualan
    ...
    Property Main As Fusoh_PembayaranPiutang
      Get
        Return _main
      End Get
      Set(value As Fusoh_PembayaranPiutang)
        SetPropertyValue(Of Fusoh_PembayaranPiutang)("Main", _main, value)
      End Set
    End Property
    <Persistent("p_idinvoice")>
    Property NoInvoice As Fusoh_InvoicePenjualan
      Get
        Return _idinvoice
      End Get
      Set(value As Fusoh_InvoicePenjualan)
        SetPropertyValue(Of Fusoh_InvoicePenjualan)("NoInvoice", _idinvoice, value)
      End Set
    End Property
  ...
  <Persistent("m06vwinvoice")> Friend Class Fusoh_ViewInvoice
    ...
    <Key()> Property NoInvoice As Fusoh_InvoicePenjualan
    ...
    Property Catatan As String
    Property Pembayaran As Fusoh_PembayaranPiutangDetail
  End Class
End Namespace