...
Friend Class UI_zNishiDebitNoteDialog
  ...
  Overrides Sub LoadAfterInitialize()
    SetFormat()
    If Tipe = InputType.Tambah Then
      Me.Text = "Debit Note [DN] : Tambah Data"
    Else
      Me.Text = "Debit Note [DN] : Edit Data " & instance.Kode
  ...
  Overrides Sub SimpanData()
    ...
    reportCode = MainClass.GetReport(MainClass.reportName.zNishiVoucherDN)
  ...
  Private Sub SetFormat()
    ...
    colQty.SummaryItem.DisplayFormat = "n2"
  ...
  Private Sub SetNomor()
    instance.Sumber = sumber.GetObject(Persistent.SumberDataJenis.DN)
