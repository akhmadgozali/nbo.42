...
Public Class UI_zNishiQuotation
  ...
  Private Sub btnCetak_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles btnCetakVoucher1.ItemClick, btnCetakVoucher2.ItemClick, btnCetakVoucher3.ItemClick
    ...
    '      Case "Voucher Invoice" : reportCode = MainClass.GetReport(MainClass.reportName.zNishiVoucherIV)
    '      Case "Voucher Invoice Storage" : reportCode = MainClass.GetReport(MainClass.reportName.zNishiVoucherIVStorage)
    '      Case "Voucher Invoice Trucking" : reportCode = MainClass.GetReport(MainClass.reportName.zNishiVoucherIVTruck)
    '      Case Else : reportCode = MainClass.GetReport(MainClass.reportName.zNishiVoucherIV)
    '    End Select
