...
Friend Class pjp_TransaksiKM
  ...
  Overrides Sub LoadBeforeInitialize()
    ...
    If My.Computer.FileSystem.FileExists(Logic.Umum.xLokasiLayout("pjpKMTransaksi.xml")) = True Then
      LayoutControl1.RestoreLayoutFromXml(Logic.Umum.xLokasiLayout("pjpKMTransaksi.xml"))
    End If
    If My.Computer.FileSystem.FileExists(Logic.Umum.xLokasiLayout("pjpKMTransaksiGrid.xml")) = True Then
      xGridView.RestoreLayoutFromXml(Logic.Umum.xLokasiLayout("pjpKMTransaksiGrid.xml"))
    End If
  End Sub
  ...
  Overrides Sub SimpanData()
    ...
    Dim frm As New RF_BuktiHarian(Persistent.SumberDataCollection.GetEnum(instance.Sumber), MainClass.reportName.BuktiKasMasuk)
    frm.txtNoBukti1.EditValue = instance.Kode

    Dim message As String = "Apakah anda ingin mencetak bukti {0} dengan nomor " & instance.Kode & " ?"
    Dim reportCode As String = ""
    reportCode = MainClass.GetReport(MainClass.reportName.BuktiKasMasuk)
  ...
  Private Sub SetTitle(kode As String)
    ...
    If kode <> Nothing Then
      x = "#" & kode
    End If
    Me.Text = "Kas Masuk : " & Tipe.ToString & x
  End Sub
  ...
  Private Sub xGridView_ColumnWidthChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.ColumnEventArgs) Handles xGridView.ColumnWidthChanged
    xGridView.SaveLayoutToXml(Logic.Umum.xLokasiLayout("pjpKMTransaksiGrid.xml"))
  End Sub
  Private Sub xpColTKI_ResolveSession(sender As Object, e As ResolveSessionEventArgs) Handles xpColTKI.ResolveSession, xpColProses.ResolveSession
    e.Session = session
  End Sub
