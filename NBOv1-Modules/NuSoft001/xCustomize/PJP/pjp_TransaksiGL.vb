...
Friend Class pjp_TransaksiGL
  ...
  Overrides Function GetDialogForm() As Core.Win.Forms.InputBase
    Select Case _jenisTransaksi
      Case JenisTransaksiGL.KasMasuk : Return New pjp_TransaksiKM
      Case JenisTransaksiGL.KasKeluar : Return New pjp_TransaksiKK
      Case JenisTransaksiGL.JurnalUmum : Return New pjp_TransaksiJU
      Case JenisTransaksiGL.JurnalAdjusment : Return New pjp_TransaksiJA
      Case Else : Return New pjp_TransaksiKK
    End Select
  End Function
