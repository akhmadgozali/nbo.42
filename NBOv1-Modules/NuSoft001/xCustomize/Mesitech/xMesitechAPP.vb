...
Friend Class xMesitechAPP
  ...
  Overrides Sub LoadBeforeInitialize()
    ...
    If My.Computer.FileSystem.FileExists(Logic.Umum.xLokasiLayout("xMesitechPA.xml")) = True Then
      lytTransaksiJU.RestoreLayoutFromXml(Logic.Umum.xLokasiLayout("xMesitechPA.xml"))
    End If
    If My.Computer.FileSystem.FileExists(Logic.Umum.xLokasiLayout("xMesitechPAGrid.xml")) = True Then
      xGridView.RestoreLayoutFromXml(Logic.Umum.xLokasiLayout("xMesitechPAGrid.xml"))
    End If
  End Sub
  Overrides Sub InitializeData()
    ...
    Else
      ...
      txtActivity.EditValue = instance.Activity
      txtJobCode.EditValue = instance.JobCode
      txtWO.EditValue = instance.WorkOrder
      txtMengajukan.EditValue = instance.Mengajukan
      txtNoInvoice.EditValue = instance.InvoiceNo
      txtTglTempo.EditValue = instance.InvoiceDueDate
      txtNilaiInvoice.EditValue = instance.InvoiceValue
  ...
  Overrides Sub SimpanData()
    ...
    Try
      ...
      instance.Activity = txtActivity.Text
      instance.JobCode = txtJobCode.Text
      instance.WorkOrder = txtWO.Text
      instance.Mengajukan = txtMengajukan.Text
      instance.InvoiceNo = txtNoInvoice.Text
      instance.InvoiceDueDate = txtTglTempo.DateTime
      instance.InvoiceValue = CType(txtNilaiInvoice.EditValue, Double)
    ...
    Dim frm As New RF_BuktiHarian(Persistent.SumberDataJenis.PA, MainClass.reportName.zBuktiJurnalAPP)
  ...
  Private Sub SetTitle(kode As String)
    ...
    If kode <> Nothing Then
      x = "#" & kode
    End If
    Me.Text = "Aplikasi Pembayaran : " & Tipe.ToString & x
  End Sub
  Private Sub SetFormat()
    ...
    txtNilaiInvoice.Properties.Mask.MaskType = DevExpress.XtraEditors.Mask.MaskType.Numeric
    txtNilaiInvoice.Properties.Mask.EditMask = setting.NumericFormatToString
    txtNilaiInvoice.Properties.Mask.UseMaskAsDisplayFormat = True
  End Sub
  Private Sub LoadDefault()
    ...
    txtNilaiInvoice.EditValue = 0.0
    txtTglTempo.EditValue = Now
  End Sub
  Private Sub SetNomor()
    instance.Sumber = sumber.GetObject(Persistent.SumberDataJenis.PA)
  End Sub
  ...
  Private Sub xGridView_ColumnWidthChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.ColumnEventArgs) Handles xGridView.ColumnWidthChanged
    xGridView.SaveLayoutToXml(Logic.Umum.xLokasiLayout("xMesitechPAGrid.xml"))
  End Sub
