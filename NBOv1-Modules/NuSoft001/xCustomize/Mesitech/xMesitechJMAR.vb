...
Friend Class xMesitechJMAR
  ...
  Overrides Sub LoadBeforeInitialize()
    ...
    If My.Computer.FileSystem.FileExists(Logic.Umum.xLokasiLayout("xMesitechJMAR.xml")) = True Then
      lytTransaksiJU.RestoreLayoutFromXml(Logic.Umum.xLokasiLayout("xMesitechJMAR.xml"))
    End If
    If My.Computer.FileSystem.FileExists(Logic.Umum.xLokasiLayout("xMesitechJMARGrid.xml")) = True Then
      xGridView.RestoreLayoutFromXml(Logic.Umum.xLokasiLayout("xMesitechJMARGrid.xml"))
    End If
  End Sub
  ...
  Overrides Sub SimpanData()
    ...
    Dim frm As New RF_MesitechTransaksi(Persistent.SumberDataJenis.JM, MainClass.reportName.BuktiJurnalUmum)
    ...
    message = String.Format(message, "Jurnal Memo")
  ...
  Private Sub SetTitle(kode As String)
    ...
    If kode <> Nothing Then
      x = "#" & kode
    End If
    Me.Text = "Jurnal Memo AR : " & Tipe.ToString & x
  End Sub
  ...
  Private Sub SetNomor()
    instance.Sumber = sumber.GetObject(Persistent.SumberDataJenis.JM)
  End Sub
  ...
  Private Sub xGridView_ColumnWidthChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.ColumnEventArgs) Handles xGridView.ColumnWidthChanged
    xGridView.SaveLayoutToXml(Logic.Umum.xLokasiLayout("xMesitechJMARGrid.xml"))
  End Sub
