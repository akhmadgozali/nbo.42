...
Friend Class xMesitechBuktiBankAR
  ...
  Overrides Sub LoadBeforeInitialize()
    ...
    If My.Computer.FileSystem.FileExists(Logic.Umum.xLokasiLayout("xMesitechBuktiBank.xml")) = True Then
      lytTransaksiJU.RestoreLayoutFromXml(Logic.Umum.xLokasiLayout("xMesitechBuktiBank.xml"))
    End If
    If My.Computer.FileSystem.FileExists(Logic.Umum.xLokasiLayout("xMesitechBuktiBankGrid.xml")) = True Then
      xGridView.RestoreLayoutFromXml(Logic.Umum.xLokasiLayout("xMesitechBuktiBankGrid.xml"))
    End If
  End Sub
  ...
  Overrides Sub SimpanData()
    ...
    Dim frm As New RF_MesitechTransaksi(Persistent.SumberDataJenis.BA, MainClass.reportName.BuktiBankMasuk)
  ...
  Private Sub BindingDataSource()
    ...
    'colAPPRrepo.DataSource = New XPCollection(Of Persistent.xMesitechGLMain)(session, New BinaryOperator("Sumber", Persistent.SumberDataJenis.PA, BinaryOperatorType.Equal))
    ...
    colInvoiceRepo.DataSource = New XPCollection(Of Persistent.InvoiceMesitech)(session)
  End Sub
  Private Sub SetTitle(kode As String)
    ...
    If kode <> Nothing Then
      x = "#" & kode
    End If
    Me.Text = "Bukti Bank : " & Tipe.ToString & x
  End Sub
  ...
  Private Sub SetNomor()
    instance.Sumber = sumber.GetObject(Persistent.SumberDataJenis.BA)
  End Sub
  ...
  Private Sub xGridView_ColumnWidthChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.ColumnEventArgs) Handles xGridView.ColumnWidthChanged
    xGridView.SaveLayoutToXml(Logic.Umum.xLokasiLayout("xMesitechBuktiBankGrid.xml"))
  End Sub
