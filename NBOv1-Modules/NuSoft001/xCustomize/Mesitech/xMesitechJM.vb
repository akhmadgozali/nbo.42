...
Friend Class xMesitechJM
  ...
  Overrides Sub LoadBeforeInitialize()
    ...
    If My.Computer.FileSystem.FileExists(Logic.Umum.xLokasiLayout("xMesitechJM.xml")) = True Then
      lytTransaksiJU.RestoreLayoutFromXml(Logic.Umum.xLokasiLayout("xMesitechJM.xml"))
    End If
    If My.Computer.FileSystem.FileExists(Logic.Umum.xLokasiLayout("xMesitechJMGrid.xml")) = True Then
      xGridView.RestoreLayoutFromXml(Logic.Umum.xLokasiLayout("xMesitechJMGrid.xml"))
    End If
  End Sub
  ...
  Private Sub SetTitle(kode As String)
    ...
    If kode <> Nothing Then
      x = "#" & kode
    End If
    Me.Text = "Jurnal Memo : " & Tipe.ToString & x
  End Sub
  ...
  Private Sub xGridView_ColumnWidthChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.ColumnEventArgs) Handles xGridView.ColumnWidthChanged
    xGridView.SaveLayoutToXml(Logic.Umum.xLokasiLayout("xMesitechJMGrid.xml"))
  End Sub
