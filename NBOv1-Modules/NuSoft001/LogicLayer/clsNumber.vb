...
Namespace Persistent
  Enum SumberDataJenis
    ...
    <EnumDescription("Saldo Awal")> SA = 90
    <EnumDescription("Pengajuan Dana")> PD = 10
    <EnumDescription("Fixed Asset")> FA = 11
    <EnumDescription("Giro Masuk")> GM = 40
    <EnumDescription("Giro Keluar")> GK = 41
    <EnumDescription("Pre Payment")> PP = 42
    <EnumDescription("APP Pembayaran")> PA = 99
    <EnumDescription("Bukti Bank AR")> BA = 100
    <EnumDescription("Jurnal Memo AR")> JM = 101
		<EnumDescription("Amortisasi BDM")> AB = 102
	End Enum
