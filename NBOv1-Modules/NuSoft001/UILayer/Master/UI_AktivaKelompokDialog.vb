...
Public Class UI_AktivaKelompokDialog
  ...
  Public Overrides Sub LoadAfterInitialize()
    ...
    txtCoaAsset.Properties.DataSource = Logic.Coa.GetCoa(session, True, New NuSoft001.Persistent.CoaEnum.eKind() {NuSoft001.Persistent.CoaEnum.eKind.AktivaTetap})
    txtCoaDepresiasi.Properties.DataSource = Logic.Coa.GetCoa(session, True, New NuSoft001.Persistent.CoaEnum.eKind() {NuSoft001.Persistent.CoaEnum.eKind.BiayaOperasional, Persistent.CoaEnum.eKind.HargaPokokPenjualan})
    txtCoaAkumDepr.Properties.DataSource = Logic.Coa.GetCoa(session, True, New NuSoft001.Persistent.CoaEnum.eKind() {NuSoft001.Persistent.CoaEnum.eKind.AkumulasiPenyusutan})
    txtCOAWriteOff.Properties.DataSource = Logic.Coa.GetCoa(session, True, New NuSoft001.Persistent.CoaEnum.eKind() {NuSoft001.Persistent.CoaEnum.eKind.BiayaOperasional, Persistent.CoaEnum.eKind.HargaPokokPenjualan, Persistent.CoaEnum.eKind.BiayaLainLain})
