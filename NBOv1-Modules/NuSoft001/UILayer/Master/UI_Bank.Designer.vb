...
Partial Class UI_Bank
  Inherits Core.Win.Forms.GridBinding
    ...
    'xpCol
    '
    Me.xpCol.ObjectType = GetType(NuSoft.NUI.Win.Forms.Modules.NuSoft001.Persistent.Bank)
    '
    'xGridView
    '
    Me.xGridView.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colId, Me.colKode, Me.colNama, Me.colNoRekening, Me.colAtasNama, Me.colKeterangan})
    ...
    'colNoRekening
    '
    Me.colNoRekening.Caption = "No Rekening"
