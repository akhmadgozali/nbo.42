...
Partial Class UI_AkunZ
  ...
  Private Sub InitializeComponent()
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(UI_AkunZ))
    ...
    Me.colCFIN = New DevExpress.XtraTreeList.Columns.TreeListColumn()
    Me.colCFOUT = New DevExpress.XtraTreeList.Columns.TreeListColumn()
    ...
    'xTree
    '
    Me.xTree.Columns.AddRange(New DevExpress.XtraTreeList.Columns.TreeListColumn() {Me.colKode, Me.colNama, Me.colNamaCashFlowTambah, Me.colNamaCashFlowMinus, Me.colTipeAkun, Me.colAktif, Me.colGabungCashFlow, Me.colDivisi, Me.colUang, Me.colCFIN, Me.colCFOUT})
    ...
    'colCFIN
    '
    Me.colCFIN.Caption = "CF IN"
    Me.colCFIN.FieldName = "ReportCashFlowIN.Nama"
    Me.colCFIN.Name = "colCFIN"
    Me.colCFIN.Visible = True
    Me.colCFIN.VisibleIndex = 9
    '
    'colCFOUT
    '
    Me.colCFOUT.Caption = "CF OUT"
    Me.colCFOUT.FieldName = "ReportCashFlowOut.Nama"
    Me.colCFOUT.Name = "colCFOUT"
    Me.colCFOUT.Visible = True
    Me.colCFOUT.VisibleIndex = 10
    '
    'UI_AkunZ
    '
  ...
  Friend WithEvents colCFIN As DevExpress.XtraTreeList.Columns.TreeListColumn
  Friend WithEvents colCFOUT As DevExpress.XtraTreeList.Columns.TreeListColumn
End Class
