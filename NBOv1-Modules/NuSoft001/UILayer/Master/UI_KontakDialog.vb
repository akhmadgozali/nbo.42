...
Public Class UI_KontakDialog
  ...
  Overrides Sub LoadBeforeInitialize()
    ...
    txtTipePajakPembelian.Properties.DataSource = Utils.Helper.EnumDescription.ToList(GetType(Persistent.eTipePajak))
    txtTipePajakPenjualan.Properties.DataSource = Utils.Helper.EnumDescription.ToList(GetType(Persistent.eTipePajak))
  ...
  Public Overrides Sub LoadAfterInitialize()
    ...
    If Tipe = InputType.Tambah Then
      ...
      txtKontakDomestik.Checked = True
      txtKategori.EditValue = Core.Win.Component.XtraLookUpEdit.GetFirstValue(txtKategori)
      txtTipePajakPembelian.EditValue = Persistent.eTipePajak.TanpaPajak
      txtTipePajakPenjualan.EditValue = Persistent.eTipePajak.TanpaPajak
    Else
      ...
      txtTipePajakPembelian.EditValue = instance.TipePajakPembelian
      ...
      txtTipePajakPenjualan.EditValue = instance.TipePajakPenjualan
      ...
      txtKontakDomestik.Checked = instance.KontakDomestik
  ...
  Public Overrides Sub SimpanData()
    Try
      ...
      instance.TipePajakPembelian = CType(txtTipePajakPembelian.EditValue, Persistent.eTipePajak)
      ...
      instance.TipePajakPenjualan = CType(txtTipePajakPenjualan.EditValue, Persistent.eTipePajak)
      ...
      instance.KontakDomestik = txtKontakDomestik.Checked
