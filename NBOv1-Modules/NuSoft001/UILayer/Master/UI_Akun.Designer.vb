...
Partial Class UI_Akun
  Inherits Core.Win.Forms.TreeInput
    ...
    Private Sub InitializeComponent()
		...
		Me.ColCFINx = New DevExpress.XtraTreeList.Columns.TreeListColumn()
		Me.ColCFOutx = New DevExpress.XtraTreeList.Columns.TreeListColumn()
		...
		Me.xpCol.ObjectType = GetType(NuSoft.NUI.Win.Forms.Modules.NuSoft001.Persistent.Coa)
		'
		'barMan
		'
		Me.barMan.Items.AddRange(New DevExpress.XtraBars.BarItem() {Me.cmdExpand, Me.cmdCollapse, Me.btnSaveLayout, Me.btnDetail, Me.btnImporData})
		Me.barMan.MaxItemId = 19
		'
		'xTree
		'
		Me.xTree.Columns.AddRange(New DevExpress.XtraTreeList.Columns.TreeListColumn() {Me.colKode, Me.colNama, Me.colNamaCashFlowTambah, Me.colNamaCashFlowMinus, Me.colTipeAkun, Me.colAktif, Me.colGabungCashFlow, Me.colDivisi, Me.colUang, Me.ColCFINx, Me.ColCFOutx})
		...
		'ColCFINx
		'
		Me.ColCFINx.Caption = "Cash Flow IN"
		Me.ColCFINx.FieldName = "ReportCashFlowIN.Nama"
		Me.ColCFINx.Name = "ColCFINx"
		Me.ColCFINx.Visible = True
		Me.ColCFINx.VisibleIndex = 6
		'
		'ColCFOutx
		'
		Me.ColCFOutx.Caption = "Cash Flow Out"
		Me.ColCFOutx.FieldName = "ReportCashFlowOut.Nama"
		Me.ColCFOutx.Name = "ColCFOutx"
		Me.ColCFOutx.Visible = True
		Me.ColCFOutx.VisibleIndex = 7
		'
		'btnImporData
		'
  ...
  Friend WithEvents ColCFINx As DevExpress.XtraTreeList.Columns.TreeListColumn
  Friend WithEvents ColCFOutx As DevExpress.XtraTreeList.Columns.TreeListColumn
