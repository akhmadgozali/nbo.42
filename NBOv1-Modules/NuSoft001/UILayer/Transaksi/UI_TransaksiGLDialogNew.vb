...
Friend Class UI_TransaksiGLDialogNew
  ...
  Overrides Sub InitializeData()
    ...
    Else
      ...
      ElseIf _jenisTransaksi = JenisTransaksiGL.KasKeluar Then
        txtTipe.EditValue = instance.Tipe
      ElseIf _jenisTransaksi = JenisTransaksiGL.BankKeluar Then
        txtTipe.EditValue = instance.Tipe
      End If
    End If
    SetNomor()
  ...
  Overrides Sub SimpanData()
    ...
    Try
      ...
      If _jenisTransaksi = JenisTransaksiGL.KasKeluar OrElse _jenisTransaksi = JenisTransaksiGL.BankKeluar OrElse _jenisTransaksi = JenisTransaksiGL.KasMasuk OrElse _jenisTransaksi = JenisTransaksiGL.BankMasuk Then
        ...
        Select Case Persistent.SumberDataCollection.GetEnum(instance.Sumber)
    ...
    Dim frm As New RF_BuktiHarian(Persistent.SumberDataCollection.GetEnum(instance.Sumber))
  ...
  Private Sub CustomizeLayout()
    Select Case _jenisTransaksi
      Case JenisTransaksiGL.KasMasuk, JenisTransaksiGL.BankMasuk
      ...
      Case JenisTransaksiGL.KasKeluar, JenisTransaksiGL.BankKeluar
        layCashAdvance.HideToCustomization()
        layCashAdvanceText.HideToCustomization()
      ...
      Case JenisTransaksiGL.JurnalUmum
        ...
        layCaraBayar2.HideToCustomization()
  ...
  Private Sub SetTitle(kode As String)
    ...
    Select Case _jenisTransaksi
      ...
      Case JenisTransaksiGL.KasKeluar : Me.Text = "Kas Keluar : " & Tipe.ToString & x
      Case JenisTransaksiGL.KasMasuk : Me.Text = "Kas Masuk : " & Tipe.ToString & x
      Case JenisTransaksiGL.BankKeluar : Me.Text = "Bank Keluar : " & Tipe.ToString & x
      Case JenisTransaksiGL.BankMasuk : Me.Text = "Bank Masuk : " & Tipe.ToString & x
    End Select
  End Sub
  ...
  Private Sub SetNomor()
    Select Case _jenisTransaksi
      ...
      Case JenisTransaksiGL.BankMasuk
        instance.Sumber = sumber.GetObject(Persistent.SumberDataJenis.BM)
      Case JenisTransaksiGL.JurnalAdjusment
        instance.Sumber = sumber.GetObject(Persistent.SumberDataJenis.JA)
    End Select
  End Sub
    ...
    Select Case _jenisTransaksi
      ...
      Case JenisTransaksiGL.JurnalUmum
        ...
        If Not txtCashAdvance.EditValue Is Nothing Then
          instance.CashAdvance = session.GetObjectByKey(Of Persistent.GlMain)(CType(txtCashAdvance.EditValue, Persistent.SisaCashAdvance).Id)
        End If
      Case JenisTransaksiGL.JurnalAdjusment
        instance.Tipe = Nothing
        instance.Akun = Nothing
  ...
  Private Sub txtAkun_EditValueChanging(sender As Object, e As DevExpress.XtraEditors.Controls.ChangingEventArgs) Handles txtAkun.EditValueChanging
    If Not e.NewValue Is Nothing Then
      ...
      If item.Tipe.Id = Persistent.CoaEnum.eKind.Kas Then
        ...
        layCaraBayar2.Visibility = LayoutVisibility.Never
        layCaraBayarDetail.Visibility = LayoutVisibility.Never
      Else
        layCaraBayar.Visibility = LayoutVisibility.Always
        layCaraBayar2.Visibility = LayoutVisibility.Always
        layCaraBayarDetail.Visibility = LayoutVisibility.Always
  ...
  Private Sub txtKurs_EditValueChanging(sender As Object, e As DevExpress.XtraEditors.Controls.ChangingEventArgs) Handles txtKurs.EditValueChanging
    If Not e.NewValue Is Nothing AndAlso Not e.NewValue.ToString = "" Then
      If Not txtAkun.EditValue Is Nothing Then
        If _jenisTransaksi = JenisTransaksiGL.KasMasuk Or _jenisTransaksi = JenisTransaksiGL.BankMasuk Then
