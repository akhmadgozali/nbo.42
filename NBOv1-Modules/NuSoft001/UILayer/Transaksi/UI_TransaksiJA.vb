...
Friend Class UI_TransaksiJA
  ...
  Overrides Sub LoadBeforeInitialize()
    ...
    If My.Computer.FileSystem.FileExists(Logic.Umum.xLokasiLayout("JATransaksi.xml")) = True Then
      lytTransaksiJa.RestoreLayoutFromXml(Logic.Umum.xLokasiLayout("JATransaksi.xml"))
    End If
    If My.Computer.FileSystem.FileExists(Logic.Umum.xLokasiLayout("JATransaksiGrid.xml")) = True Then
      xGridView.RestoreLayoutFromXml(Logic.Umum.xLokasiLayout("JATransaksiGrid.xml"))
    End If
  ...
  Private Sub LoadDefault()
    ...
    txtUraian.Text = setting.UraianJA
  End Sub
  ...
  Private Sub xGridView_ColumnWidthChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.ColumnEventArgs) Handles xGridView.ColumnWidthChanged
    xGridView.SaveLayoutToXml(Logic.Umum.xLokasiLayout("JATransaksiGrid.xml"))
  End Sub
