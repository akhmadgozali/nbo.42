...
Friend Class UI_AktivaTetapPenjualan
  ...
  Overrides Sub LoadBeforeInitialize()
    ...
    colKodeAssetRepo.DataSource = New XPCollection(Of Persistent.AktivaTetap)(session, New GroupOperator(GroupOperatorType.And, New BinaryOperator("Pembelian", True), New BinaryOperator("Dispose", False)))
  ...
  Overrides Sub InitializeData()
    ...
    If Tipe = InputType.Tambah Then
      ...
      ChangeCode()
      txtUraian.EditValue = "Penjualan Aktiva Tetap"
      xGrid.DataSource = instance.Detail
      Me.Text = "Penjualan Aktiva Tetap: Tambah"
    Else
      xGrid.DataSource = Nothing
      ...
      xGrid.DataSource = instance.Detail
      Me.Text = "Penjualan Aktiva Tetap: Edit - " & instance.Kode
    End If
  End Sub
  ...
  Overrides Sub SimpanData()
    ...
    Try
      ...
      instance.Tipe = Persistent.eTipeTransaksiAsset.Penjualan
      ...
      instance.GL.Uraian = "Penjualan Aktiva Tetap"
