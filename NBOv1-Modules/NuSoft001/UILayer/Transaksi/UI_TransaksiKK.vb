...
Friend Class UI_TransaksiKK
  ...
  Private defaultRegional As NPO.Modules.ModSys.Regional
	...
	Private xTotalTransaksiEdit As Double
  ...
  Overrides Sub LoadBeforeInitialize()
    ...
    colDivisi.Visible = setting.MultiDivisi
		...
		BindingDataSource()
		If My.Computer.FileSystem.FileExists(Logic.Umum.xLokasiLayout("KKTransaksi.xml")) = True Then
			LayoutControl1.RestoreLayoutFromXml(Logic.Umum.xLokasiLayout("KKTransaksi.xml"))
		End If
		If My.Computer.FileSystem.FileExists(Logic.Umum.xLokasiLayout("KKTransaksiGrid.xml")) = True Then
      xGridView.RestoreLayoutFromXml(Logic.Umum.xLokasiLayout("KKTransaksiGrid.xml"))
    End If
  End Sub
  Overrides Sub InitializeData()
    ...
    Else
      ...
      SetSumberKasBank(instance.Akun)
			...
			xTotalTransaksiEdit = instance.Saldo
		End If
  ...
  Overrides Sub SimpanData()
    ...
    Next
		...
		If Tipe = InputType.Edit Then
			If xTotalTransaksiEdit.ToString("n2") <> instance.Detail.Sum(Function(m) m.Debit).ToString("n2") Then
				If MsgBox("Total transaksi yang anda edit berbeda dengan total transaksi sebelumnya. Apakah anda ingin meneruskan?", vbYesNo, "Konfirmasi") = MsgBoxResult.No Then
					Throw New Utils.Exception("Silahkan edit nilai transaksi anda.", 0, "", "Simpan Transaksi")
					Exit Sub
				End If
			End If
		End If
    ...
    Try
      ...
      If Tipe = InputType.Tambah Then
        ...
        End If
      Else
        'instance.Detail.Criteria = Nothing
  ...
  Private Sub BindingDataSource()
    ...
    txtTipe.Properties.DataSource = Utils.Helper.EnumDescription.ToList(GetType(Persistent.KasBankKeluarTipe))
		...
		End If
		txtCopy.Properties.DataSource = New XPCollection(Of Persistent.GlMain)(session, New BinaryOperator("Sumber", sumber.GetObject(Persistent.SumberDataJenis.KK), BinaryOperatorType.Equal))
	End Sub
  ...
  Private Sub LoadDefault()
    ...
    txtUraian.Text = setting.UraianKK
  End Sub
  ...
  Private Sub xGridView_ColumnWidthChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.ColumnEventArgs) Handles xGridView.ColumnWidthChanged
    xGridView.SaveLayoutToXml(Logic.Umum.xLokasiLayout("KKTransaksiGrid.xml"))
  End Sub
