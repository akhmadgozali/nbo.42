...
Friend Class UI_TransaksiJU
  ...
  Overrides Sub LoadBeforeInitialize()
    ...
    colDivisi.Visible = setting.MultiDivisi
		...
		BindingDataSource()
		If My.Computer.FileSystem.FileExists(Logic.Umum.xLokasiLayout("JUTransaksi.xml")) = True Then
			lytTransaksiJU.RestoreLayoutFromXml(Logic.Umum.xLokasiLayout("JUTransaksi.xml"))
		End If
		If My.Computer.FileSystem.FileExists(Logic.Umum.xLokasiLayout("JUTransaksiGrid.xml")) = True Then
      xGridView.RestoreLayoutFromXml(Logic.Umum.xLokasiLayout("JUTransaksiGrid.xml"))
    End If
  End Sub
  Overrides Sub InitializeData()
    ...
    Else
      ...
      xGrid.DataSource = instance.Detail
      If Not instance.CashAdvance Is Nothing Then
  ...
  Private Sub BindingDataSource()
    ...
    Else
      colAkunRepo.DataSource = Logic.Coa.GetCoa(session, True, New Persistent.CoaEnum.eKind() {Persistent.CoaEnum.eKind.AktivaLancarLainnya, Persistent.CoaEnum.eKind.AktivaTetap, Persistent.CoaEnum.eKind.AkumulasiPenyusutan, Persistent.CoaEnum.eKind.BiayaLainLain, Persistent.CoaEnum.eKind.BiayaOperasional, Persistent.CoaEnum.eKind.HargaPokokPenjualan, Persistent.CoaEnum.eKind.HutangJangkaPanjang, Persistent.CoaEnum.eKind.HutangJangkaPendek, Persistent.CoaEnum.eKind.HutangLancarLainnya, Persistent.CoaEnum.eKind.Modal, Persistent.CoaEnum.eKind.Pendapatan, Persistent.CoaEnum.eKind.PendapatanLainLain, Persistent.CoaEnum.eKind.Persediaan, Persistent.CoaEnum.eKind.Piutang, Persistent.CoaEnum.eKind.Pajak})
    End If
    ...
    colProyekRepo.DataSource = New XPCollection(Of Persistent.Proyek)(session)
		txtCopy.Properties.DataSource = New XPCollection(Of Persistent.GlMain)(session, New BinaryOperator("Sumber", sumber.GetObject(Persistent.SumberDataJenis.JU), BinaryOperatorType.Equal))
	End Sub
  ...
  Private Sub LoadDefault()
    ...
    txtUraian.Text = setting.UraianJU
  End Sub
  ...
  Private Sub xGridView_ColumnWidthChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.ColumnEventArgs) Handles xGridView.ColumnWidthChanged
    xGridView.SaveLayoutToXml(Logic.Umum.xLokasiLayout("JUTransaksiGrid.xml"))
  End Sub
	...
	Private Sub btnCopy_Click(sender As Object, e As EventArgs) Handles btnCopy.Click
		...
		If Not txtCopy.EditValue Is Nothing Then
			...
			For pi = 0 To xMain.Detail.Count - 1
				...
				item.Urutan = CType(CByte(pi) + 1, UShort)
