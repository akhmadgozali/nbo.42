...
Friend Class UI_TransaksiKM
  ...
  Overrides Sub LoadBeforeInitialize()
    ...
    If My.Computer.FileSystem.FileExists(Logic.Umum.xLokasiLayout("KMTransaksi.xml")) = True Then
      LayoutControl1.RestoreLayoutFromXml(Logic.Umum.xLokasiLayout("KMTransaksi.xml"))
    End If
    If My.Computer.FileSystem.FileExists(Logic.Umum.xLokasiLayout("KMTransaksiGrid.xml")) = True Then
      xGridView.RestoreLayoutFromXml(Logic.Umum.xLokasiLayout("KMTransaksiGrid.xml"))
    End If
  End Sub
	Overrides Sub InitializeData()
		...
		SetNomor()
		ChangeTotalValas()
		txtCopy.Properties.DataSource = New XPCollection(Of Persistent.GlMain)(session, New BinaryOperator("Sumber", sumber.GetObject(Persistent.SumberDataJenis.KM), BinaryOperatorType.Equal))
	End Sub
  ...
  Private Sub LoadDefault()
    ...
    txtUraian.Text = setting.UraianKM
  End Sub
  ...
  End Sub
	Private Sub xGridView_ColumnWidthChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.ColumnEventArgs) Handles xGridView.ColumnWidthChanged
		xGridView.SaveLayoutToXml(Logic.Umum.xLokasiLayout("KMTransaksiGrid.xml"))
	End Sub
