...
Public Class UI_SaldoARAPNew
  ...
  Private Function CreateCriteriaDetail(xKodeKontak As String, xMataUang As String) As CriteriaOperator
    ...
    'tambahin coa setup
    Dim xdtSetup As New XPCollection(Of Persistent.SetupARAP)(session)
    'New NotOperator(New InOperator("f_coa", xdtSetup.ToList.Select(Function(m) m.COA))
    result.Add(New NotOperator(New InOperator("Akun", xdtSetup.ToList.Select(Function(m) m.COA))))
