...
Friend Class UI_DaftarGL
  ...
  Overrides Sub FirstLoad()
    ...
    End If
    Dim regional = Core.SSystem.UserInfo.GetUserRegional(session, session.Connection.Database)
    Dim filter = New InOperator("Main.Regional", regional.ToList())
    xpCol.Criteria = filter
    ...
    colSelisih.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
    colSelisih.DisplayFormat.FormatString = a.NumericFormatString
  End Sub
