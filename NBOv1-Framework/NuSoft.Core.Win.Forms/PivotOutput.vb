...
Namespace NuSoft.Core.Win.Forms
  Public Class PivotOutput
    ...
    Sub New()
      ...
      barMan.SetPopupContextMenu(xPivot, popMenu)
    End Sub
    ...
    End Function
    'Overridable Function GetToolTipContent(ByVal view As DevExpress.XtraPivotGrid.PivotGridControl, ByVal info As DevExpress.XtraGrid.Views.Grid.ViewInfo.GridHitInfo) As String
    '  Return ""
    'End Function
    ...
    Private Sub Me_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
      If Not xChart Is Nothing AndAlso Not DesignMode Then
        ...
        CreatePalettesMenu()
        For i = xChart.Series.Count - 1 To 0 Step -1
          xChart.Series.Remove(xChart.Series(i))
        Next
        xChart.DataSource = xPivot
      End If
    ...
    Private Sub popMenuEksport_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles popMenuEksport.ItemClick
      Core.Win.Component.XtraPivotGrid.ExportExcel(xPivot, session, Me.Text)
    End Sub
    Private Sub popMenuCetak_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles popMenuCetak.ItemClick
      Core.Win.Component.XtraPivotGrid.PrintPreview(xPivot, session, Me.Text)
    End Sub
    ...
    Private Sub xPivot_CustomCellValue(sender As Object, e As DevExpress.XtraPivotGrid.PivotCellValueEventArgs) Handles xPivot.CustomCellValue
      PivotCustomCellValue(e)
    End Sub
    Overridable Sub PivotCustomCellValue(e As DevExpress.XtraPivotGrid.PivotCellValueEventArgs)
