...
Namespace NuSoft.Utils.FTPWebRequest
...
#Region "private supporting fns"
    ...
    Private Function GetRequest(ByVal URI As String) As Net.FtpWebRequest
      'create request
      Dim result As Net.FtpWebRequest = CType(Net.FtpWebRequest.Create(URI), Net.FtpWebRequest)
    ...
    Private Function GetStringResponse(ByVal ftp As Net.FtpWebRequest) As String
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function GetSize(ByVal ftp As Net.FtpWebRequest) As Long
      Dim size As Long
      Using response As FtpWebResponse = CType(ftp.GetResponse, FtpWebResponse)
