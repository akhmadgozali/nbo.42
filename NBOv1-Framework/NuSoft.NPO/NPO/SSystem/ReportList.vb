...
Namespace NuSoft.NPO.SSystem
  ...
  Public Class Laporan
    ...
    <Persistent("d_name")> Property Nama As String
      ...
      End Set
    End Property
    <Persistent("d_parent"), Association("Parent_Children")> Property Induk As Laporan
      Get
        Return _induk
      End Get
      Set(value As Laporan)
        SetPropertyValue(Of Laporan)("Induk", _induk, value)
      End Set
    End Property
    ...
    <Association("Parent_Children")> ReadOnly Property Koleksi() As XPCollection(Of Laporan)
      Get
        Return GetCollection(Of Laporan)("Koleksi")
      End Get
    End Property
  End Class
End Namespace